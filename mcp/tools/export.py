...
log = logging.getLogger("reasongraph.mcp.tools.export")
...
def handle_export_graph(args: dict) -> dict:
    ...
    try:
        ...
        if fmt in ("graphml",):
            try:
                from reasongraph.export import GraphMLExporter
...
EXPORT_TOOLS = [
    {
        "name": "export_graph",
        "description": (
            "Export the Reasongraph knowledge graph to JSON, CSV, GraphML, Parquet, "
