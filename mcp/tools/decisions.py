...
log = logging.getLogger("reasongraph.mcp.tools.decisions")
...
DECISION_TOOLS = [
    {
        ...
        "description": "Record a decision with full context, causal links, and metadata into the Reasongraph knowledge graph.",
