"""
Resource handlers for Reasongraph MCP resources.

Each resource maps a reasongraph:// URI to a callable that returns
{"uri": ..., "mimeType": ..., "text": ...}.
"""
...
log = logging.getLogger("reasongraph.mcp.resources")
...
_HANDLERS: dict[str, object] = {
    "reasongraph://graph/summary": _read_graph_summary,
    "reasongraph://decisions/list": _read_decisions_list,
    "reasongraph://schema/info": _read_schema_info,
    "reasongraph://ontology/schema": _read_ontology_schema,
}
...
RESOURCE_DEFINITIONS = [
    ...
    },
    {
        ...
        "name": "Schema Info",
        "description": "Reasongraph schema version, supported node/edge types, and available tool names.",
        "mimeType": "application/json",
    },
    {
        "uri": "reasongraph://ontology/schema",
