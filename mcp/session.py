...
lifetime of the MCP server process.  Set REASONGRAPH_KG_PATH to
...
log = logging.getLogger("reasongraph.mcp.session")
...
def get_graph() -> Any:
    ...
    if _graph is None:
        ...
        kg_path = os.environ.get("REASONGRAPH_KG_PATH", "").strip()
