# Reasongraph — OpenClaw Plugin

> **v0.4.0** — Adds all 17 Reasongraph skills, 3 agents, and the full MCP integration to [OpenClaw](https://openclaw.ai) — the open-source personal AI agent platform.
...
OpenClaw will automatically discover all 17 Reasongraph tools and 3 agents.
