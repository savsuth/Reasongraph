---
name: policy
description: Define and enforce policies, access controls, and compliance rules over Reasongraph knowledge graphs.
---

# /reasongraph:policy

Apply policy rules and checks. Usage: `/reasongraph:policy <task> [args]`
...
```python
from reasongraph.policy import PolicyEngine
