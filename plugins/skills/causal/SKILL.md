---
name: causal
description: Analyze cause-and-effect relationships in the Reasongraph knowledge graph — causal chains, interventions, counterfactuals, and causal influence scores.
---

# /reasongraph:causal

Analyze causal relationships and infer impacts. Usage: `/reasongraph:causal <task> [args]`
