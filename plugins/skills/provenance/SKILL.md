---
name: provenance
description: Trace data lineage, source attribution, audit trails, and provenance assertions in Reasongraph graphs.
---

# /reasongraph:provenance

Inspect provenance metadata. Usage: `/reasongraph:provenance <task> [args]`
...
```python
from reasongraph.provenance import ProvenanceTracer
