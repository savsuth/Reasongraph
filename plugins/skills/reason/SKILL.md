---
name: reason
description: Run reasoning over the Reasongraph knowledge graph — deductive logic, abductive hypothesis generation, Datalog programs, SPARQL queries, Rete network evaluation. Uses DeductiveReasoner, AbductiveReasoner, DatalogReasoner, SPARQLReasoner, ReteEngine. Sub-commands: deductive, abductive, datalog, sparql, rete, prove, hypotheses.
---

# /reasongraph:reason

Apply reasoning over the knowledge graph. Usage: `/reasongraph:reason <mode> [args]`
...
```python
from reasongraph.reasoning.deductive_reasoner import DeductiveReasoner, Premise
...
```python
from reasongraph.reasoning.abductive_reasoner import (
...
```python
from reasongraph.reasoning.datalog_reasoner import DatalogReasoner
...
```python
from reasongraph.reasoning.sparql_reasoner import SPARQLReasoner
from reasongraph.context import ContextGraph
...
```python
from reasongraph.reasoning.rete_engine import ReteEngine
import json
...
```python
from reasongraph.reasoning.abductive_reasoner import AbductiveReasoner, Observation
import json
