---
name: decision
description: Full decision lifecycle in Reasongraph — record, query, find precedents (hybrid/advanced), analyze influence, explain, insights dashboard, list, and record exceptions. Uses AgentContext, ContextGraph, DecisionQuery, CausalChainAnalyzer, DecisionRecorder.
---

# /reasongraph:decision

Full decision lifecycle management. Usage: `/reasongraph:decision <sub-command> [args]`
...
```python
from reasongraph.context.decision_query import DecisionQuery
...
```python
from reasongraph.context.decision_recorder import DecisionRecorder
from reasongraph.context import AgentContext
