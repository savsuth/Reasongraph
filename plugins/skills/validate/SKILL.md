---
name: validate
description: Validate Reasongraph pipelines, extraction quality, graph schemas, and ontology consistency. Returns structured error/warning checklists. Uses PipelineValidator, PipelineBuilder.validate_pipeline(), GraphValidator, and OntologyValidator. Sub-commands: pipeline, step, dependencies, extraction, graph, ontology, performance.
---

# /reasongraph:validate

Validate pipeline and graph quality. Usage: `/reasongraph:validate <target> [options]`
...
```python
from reasongraph.pipeline.pipeline_builder import PipelineBuilder
from reasongraph.pipeline.pipeline_validator import PipelineValidator
...
```python
from reasongraph.semantic_extract.extraction_validator import ExtractionValidator
from reasongraph.semantic_extract import (
    NamedEntityRecognizer,
    RelationExtractor,
)
from reasongraph.semantic_extract.cache import _result_cache
...
```python
from reasongraph.kg.graph_validator import GraphValidator
...
```python
from reasongraph.ontology import OntologyValidator
