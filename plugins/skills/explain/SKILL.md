---
name: explain
description: Explain Reasongraph reasoning, decision logic, and graph results with traceability, causal context, and human-readable rationale.
---

# /reasongraph:explain

Produce explanations for decisions, rules, and graph analytics. Usage: `/reasongraph:explain <target> [args]`
...
# For decision explainability in Reasongraph contexts:
