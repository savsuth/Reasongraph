---
name: change
description: Track and inspect graph changes, diffs, temporal updates, and the impact of new data on Reasongraph knowledge graphs.
---

# /reasongraph:change

Inspect changes over time and evaluate updates. Usage: `/reasongraph:change <task> [args]`
...
```python
from reasongraph.provenance.change_tracker import ChangeTracker
