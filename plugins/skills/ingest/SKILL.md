---
name: ingest
description: Ingest data from files, databases, APIs, or streams into Reasongraph knowledge graphs with schema mapping and entity linking.
---

# /reasongraph:ingest

Ingest new data into the knowledge graph. Usage: `/reasongraph:ingest <source> [args]`
