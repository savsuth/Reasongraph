---
name: export
description: Export Reasongraph graphs, results, and provenance to JSON, RDF, Parquet, CSV, GraphML, and other formats.
---

# /reasongraph:export

Export knowledge graph data. Usage: `/reasongraph:export <format> [args]`
