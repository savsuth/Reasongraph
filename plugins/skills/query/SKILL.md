---
name: query
description: Query the Reasongraph knowledge graph using SPARQL, Cypher, keyword search, and structured graph query patterns.
---

# /reasongraph:query

Run graph queries and search. Usage: `/reasongraph:query <mode> [args]`
...
```python
from reasongraph.query import QueryEngine
