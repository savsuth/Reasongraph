...
Reasongraph uses FastEmbed by default for efficient, local embedding generation.

```python
from reasongraph.embeddings import TextEmbedder
...
```python
from reasongraph.embeddings.methods import embed_text
...
```python
from reasongraph.embeddings import TextEmbedder, EmbeddingGenerator
...
```python
from reasongraph.embeddings import check_available_providers
...
```python
from reasongraph.embeddings import list_available_methods
...
```python
from reasongraph.embeddings import MeanPooling
...
```python
from reasongraph.embeddings import MaxPooling
...
```python
from reasongraph.embeddings import CLSPooling
...
```python
from reasongraph.embeddings import AttentionPooling
...
```python
from reasongraph.embeddings import HierarchicalPooling
...
```python
from reasongraph.embeddings.methods import pool_embeddings
...
```python
from reasongraph.embeddings.methods import calculate_similarity
...
```python
from reasongraph.embeddings import OpenAIStore
...
```python
from reasongraph.embeddings import BGEStore
...
```python
from reasongraph.embeddings import FastEmbedStore
...
```python
from reasongraph.embeddings import ProviderStoreFactory
...
```python
from reasongraph.embeddings import VectorEmbeddingManager
import numpy as np
...
```python
from reasongraph.embeddings import GraphEmbeddingManager
...
```python
from reasongraph.embeddings.methods import generate_embeddings
...
```python
from reasongraph.embeddings.methods import embed_text, embed_image
...
```python
from reasongraph.embeddings.registry import method_registry
...
```python
from reasongraph.embeddings.methods import list_available_methods
...
```python
from reasongraph.embeddings.methods import get_embedding_method
...
```python
from reasongraph.embeddings.config import embeddings_config
...
```python
from reasongraph.embeddings.config import EmbeddingsConfig
...
```python
from reasongraph.embeddings import (
    EmbeddingGenerator,
...
```python
from reasongraph.embeddings import EmbeddingGenerator, calculate_similarity
...
```python
from reasongraph.embeddings import ContextManager, TextEmbedder
