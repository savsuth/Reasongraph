...
for the Reasongraph framework, supporting text content with multiple embedding models
...
Example Usage:
    >>> from reasongraph.embeddings import embed_text, calculate_similarity
