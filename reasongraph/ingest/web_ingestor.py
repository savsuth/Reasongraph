...
capabilities for the Reasongraph framework, enabling ingestion from websites and
web-based sources.
...
class RobotsChecker:
    ...
    def __init__(self, user_agent: str = "ReasongraphBot/1.0"):
        """
...
class WebIngestor:
    ...
    def __init__(
        self,
        user_agent: str = "ReasongraphBot/1.0",
        delay: float = 1.0,
        ...
        **kwargs,
        ...
        Args:
            user_agent: User agent string for HTTP requests (default: "ReasongraphBot/1.0")
            delay: Minimum delay between requests in seconds (default: 1.0)
        ...
        user_agent = user_agent or self.config.get("user_agent", "ReasongraphBot/1.0")
