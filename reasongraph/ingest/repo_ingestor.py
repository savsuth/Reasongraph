...
Reasongraph framework, enabling repository cloning, code analysis, and commit
history processing.
...
class RepoIngestor:
    ...
    def _filter_clone_options(options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Reasongraph processing options — never forwarded to clone_from
        non_git_options = {
            "include_history",
            "file_filters",
            "commit_filters",
    ...
    def _get_temp_dir(self) -> str:
        ...
        if self.temp_dir is None:
            self.temp_dir = tempfile.mkdtemp(prefix="reasongraph_repo_")
