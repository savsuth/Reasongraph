    ...
    with _dns_executor_lock:
        if _dns_executor is None:
            _dns_executor = concurrent.futures.ThreadPoolExecutor(
                ...
                thread_name_prefix="reasongraph-ssrf-dns",
            )
...
def _apply_connection_pin(
    ...
    if getattr(_current, "_reasongraph_pinned", False):
        _current.close()
    ...
    if pinned_ips:
        ...
        adapter._reasongraph_pinned = True
...
_SESSION_LOCK_ATTR = "_reasongraph_ssrf_lock"
