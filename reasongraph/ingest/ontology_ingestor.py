...
and convert them into Reasongraph's internal ontology dictionary format.
...
Key Features:
    ...
    - Conversion to Reasongraph ontology structure
...
class OntologyIngestor:
    ...
    This class parses OWL/RDF files and converts them to Reasongraph's ontology dictionary format.
    """
    ...
    def _convert_to_dict(self, graph: Graph, source_path: str, format: str = "unknown") -> Dict[str, Any]:
        """
        Convert rdflib Graph to Reasongraph ontology dictionary.
            ...
            for s, p, o in graph.triples((None, RDF.type, c_type)):
                ...
                if uri not in classes:
                    ...
                    if label:
                        ...
                        # But Reasongraph seems to use "name" for the identifier in some examples.
