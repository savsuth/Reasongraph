...
Reasongraph framework, enabling data extraction from Snowflake data warehouses.
...
class SnowflakeIngestor:
    ...
    def export_as_documents(
        ...
        """
        Convert Snowflake data to document format for Reasongraph processing.
