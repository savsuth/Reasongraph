...
Example Usage:
    >>> from reasongraph.ingest.methods import ingest, ingest_file, ingest_web
    >>> # Unified ingestion
...
def ingest_parquet(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_parquet
...
def ingest_arrow(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_arrow
...
def ingest_xml(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_xml
...
def ingest_web(
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_web
        >>> content = ingest_web("https://example.com", method="url")
...
def ingest_public_api(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_public_api
...
def ingest_feed(
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_feed
...
def ingest_repository(
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_repository
...
def ingest_email(
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_email
        >>> emails = ingest_email(
...
def ingest_ontology(
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_ontology
...
def ingest_database(
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_database
...
def ingest_mcp(
    ...
    **IMPORTANT**: Supports only Python MCP servers and FastMCP servers.
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest_mcp
...
def ingest(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.ingest.methods import ingest
        >>> # File ingestion
        >>> result = ingest("document.pdf", source_type="file")
        >>> # Web ingestion
