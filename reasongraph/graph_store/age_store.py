...
property graph storage and Cypher querying in the Reasongraph framework, supporting
...
Note:
    ...
    - Semantic IDs can be stored in the ``reasongraph_id`` property.
...
class ApacheAgeStore:
    ...
    - ID separation (AGE internal vs semantic ``reasongraph_id``)
    """
    ...
    def __init__(
        ...
        **config,
        ...
        self.graph_name = graph_name or config.get("graph_name", "reasongraph")
    ...
    def create_node(
        ...
        **options,
        ...
        If ``reasongraph_id`` is present in *properties* it is preserved as-is;
