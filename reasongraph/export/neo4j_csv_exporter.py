...
This module writes Reasongraph knowledge graphs to the two CSV files expected by
...
The exporter accepts the canonical Reasongraph ``{"entities": ..., "relationships": ...}``
        ...
        **options: Any,
        ...
        Raises:
            ValidationError: if a mapping payload carries no recognized graph
                ...
                see
                :func:`~reasongraph.utils.helpers.normalize_graph_payload`.
