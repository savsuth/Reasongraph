...
for the Reasongraph framework, enabling ontology export for semantic modeling.
...
# NamespaceManager "reasongraph" entry, so ontology URIs, KG instance URIs, and
...
class OWLExporter:
    ...
    def _export_owl_xml(self, ontology: Dict[str, Any], **options) -> str:
        ...
        ontology_name = ontology.get("name", "ReasongraphOntology")
    ...
    def export_classes(
        ...
        ontology_name: str = "ReasongraphOntology",
        **options,
    ) -> None:
        """
        ...
        Args:
            ...
            ontology_name: Ontology name (default: "ReasongraphOntology")
