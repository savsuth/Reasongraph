...
IMPORTANT: This module now uses the unified reasongraph.provenance.ProvenanceManager
...
class ProvenanceTracker:
    ...
    This class now wraps reasongraph.provenance.ProvenanceManager for enhanced
