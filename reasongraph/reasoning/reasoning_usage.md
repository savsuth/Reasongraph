...
The **Reasongraph Reasoning Module** provides a suite of tools for deriving new knowledge from existing facts and knowledge graphs. It supports multiple strategies including rule-based inference, SPARQL-based reasoning, and specialized abductive/deductive reasoners.

## 🚀 Quick Start

```python
from reasongraph.reasoning import Reasoner, Rule, Fact
...
```python
from reasongraph.reasoning import ReteEngine, Fact
...
```python
from reasongraph.reasoning import ExplanationGenerator
