...
class OpenAIProvider(BaseProvider):
    ...
    def _init_client(self):
        ...
        try:
            ...
            self.client = None
            self.logger.warning(
                "openai library not installed. Install with: pip install reasongraph[llm-openai]"
            )
...
class GeminiProvider(BaseProvider):
    ...
    def _init_client(self):
        ...
        try:
            ...
            self.client = None
            self.logger.warning("Gemini SDK not installed. Install with: pip install reasongraph[llm-gemini]")
...
class GroqProvider(BaseProvider):
    ...
    def _init_client(self):
        ...
        try:
            ...
            self.client = None
            self.logger.warning(
                "groq library not installed. Install with: pip install reasongraph[llm-groq]"
            )
        except Exception as e:
            self.client = None
...
class AnthropicProvider(BaseProvider):
    ...
    def _init_client(self):
        ...
        try:
            ...
            self.client = None
            self.logger.warning(
                "anthropic library not installed. Install with: pip install reasongraph[llm-anthropic]"
            )
...
class OllamaProvider(BaseProvider):
    ...
    def _init_client(self):
        ...
        try:
            ...
            self.client = None
            self.logger.warning(
                "ollama library not installed. Install with: pip install reasongraph[llm-ollama]"
            )
...
class HuggingFaceLLMProvider(BaseProvider):
    ...
    def _init_model(self):
        ...
        try:
            ...
            self.logger.warning(
                "transformers library not installed. Install with: pip install reasongraph[models-huggingface]"
            )
        except Exception as e:
            self.logger.warning(
