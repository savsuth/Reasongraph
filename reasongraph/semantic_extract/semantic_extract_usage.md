...
```python
from reasongraph.semantic_extract import EntityClassifier, EntityConfidenceScorer
...
relations = extractor.extract(
    text, 
    entities=entities, 
    model="reasongraph/relation-model-v1", # Replace with your model ID
    device="cpu"
)
...
```python
from reasongraph.semantic_extract import Relation
...
```python
from reasongraph.semantic_extract import TripletExtractor
...
```python
from reasongraph.semantic_extract import TripletExtractor, RDFSerializer
...
```python
from reasongraph.semantic_extract import TripletValidator, TripletQualityChecker
...
```python
from reasongraph.semantic_extract import EventDetector
...
```python
from reasongraph.semantic_extract import EventClassifier
...
```python
from reasongraph.semantic_extract import TemporalEventProcessor
...
```python
from reasongraph.semantic_extract import CoreferenceResolver
...
```python
from reasongraph.semantic_extract import PronounResolver
...
```python
from reasongraph.semantic_extract import EntityCoreferenceDetector
...
```python
from reasongraph.semantic_extract import SemanticAnalyzer
...
```python
from reasongraph.semantic_extract import RoleLabeler
...
```python
from reasongraph.semantic_extract import SemanticClusterer
...
```python
from reasongraph.semantic_extract import SimilarityAnalyzer
...
```python
from reasongraph.semantic_extract import SemanticNetworkExtractor
...
```python
from reasongraph.semantic_extract import SemanticNode, SemanticEdge
...
```python
from reasongraph.semantic_extract.registry import method_registry
