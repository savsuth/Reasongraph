    ...
    def __init__(self, config=None, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional configuration options:
                - base_uri: Base URI for ontology (default: "https://reasongraph.dev/ontology/")
...
class SHACLGenerator:
    """
    Generates SHACL shapes from Reasongraph OWL ontology dicts.
    ...
    def __init__(
        self,
        base_uri: str = "https://reasongraph.dev/shapes/",
    ...
    def generate(self, ontology: Dict[str, Any], **options) -> SHACLGraph:
        """Generate a SHACLGraph from a Reasongraph ontology dict."""
