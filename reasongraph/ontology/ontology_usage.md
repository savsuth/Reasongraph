...
```python
from reasongraph.ontology import OntologyGenerator, ClassInferrer, PropertyGenerator
...
```python
from reasongraph.ingest import OntologyIngestor
...
```python
from reasongraph.ontology import OntologyEngine, OntologyGenerator
...
```python
from reasongraph.ontology import OntologyEngine
...
```python
from reasongraph.ontology import ingest_ontology
...
You can also use the unified `reasongraph.ingest` interface.

```python
from reasongraph.ingest import ingest
...
```python
from reasongraph.ontology import OntologyEngine, ClassInferrer
...
```python
from reasongraph.ontology import ClassInferrer
...
```python
from reasongraph.ontology import OntologyEngine, PropertyGenerator
...
```python
from reasongraph.ontology import PropertyGenerator
...
```python
from reasongraph.ontology import OntologyEngine, OntologyValidator
...
```python
from reasongraph.ontology import OntologyEngine, OWLGenerator
...
```python
from reasongraph.ontology import OWLGenerator
...
```python
from reasongraph.ontology import OntologyEngine, OntologyEvaluator
...
```python
from reasongraph.ontology import OntologyEvaluator
...
```python
from reasongraph.ontology import RequirementsSpecManager
...
```python
from reasongraph.ontology import CompetencyQuestionsManager
...
```python
from reasongraph.ontology import ReuseManager
...
```python
from reasongraph.ontology import VersionManager
...
```python
from reasongraph.ontology import NamespaceManager
...
```python
from reasongraph.ontology import AssociativeClassBuilder
...
```python
from reasongraph.ontology.methods import get_ontology_method, list_available_methods
...
```python
from reasongraph.ontology.registry import method_registry
...
# Use custom method
from reasongraph.ontology.methods import get_ontology_method
...
```python
from reasongraph.ontology.config import ontology_config

# Get configuration values
base_uri = ontology_config.get("base_uri", default="https://reasongraph.dev/ontology/")
...
```python
from reasongraph.ontology.config import OntologyConfig
...
```python
from reasongraph.ontology import (
    OntologyGenerator,
    ClassInferrer,
    PropertyGenerator,
    OntologyValidator,
...
```python
from reasongraph.ontology import OntologyEngine, RequirementsSpecManager, CompetencyQuestionsManager
...
```python
from reasongraph.ontology import OntologyEngine, VersionManager
...
```python
from reasongraph.ontology import OntologyEngine
from reasongraph.kg import build
...
Reference: `OntologyValidator` implementation at `reasongraph/ontology/ontology_validator.py:59`.
...
OWL generation uses `OWLGenerator` at `reasongraph/ontology/owl_generator.py:277` for fallback formatting and rdflib-based generation at `reasongraph/ontology/owl_generator.py:156`.
...
Evaluation includes gap analysis and completeness; see `reasongraph/ontology/ontology_evaluator.py:203`.

## Migration Notes

- Removed global convenience wrappers (e.g., `generate_ontology`, `validate_ontology`).
- Use `OntologyEngine` or direct classes:
  - Generation: `OntologyGenerator().generate_ontology(...)` at `reasongraph/ontology/ontology_generator.py:231`
  - Classes: `ClassInferrer().infer_classes(...)` at `reasongraph/ontology/class_inferrer.py:1`
  - Properties: `PropertyGenerator().infer_properties(...)` at `reasongraph/ontology/property_generator.py:1`
  - Validation: `OntologyValidator().validate_ontology(...)` at `reasongraph/ontology/ontology_validator.py:59`
  - OWL: `OWLGenerator().generate_owl(...)` at `reasongraph/ontology/owl_generator.py:277`
