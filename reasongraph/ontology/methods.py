...
Main Functions:
    ...
    - ingest_ontology: Ingest ontology from file or directory (via reasongraph.ingest)

Example Usage:
    >>> from reasongraph.ontology.methods import generate_ontology, infer_classes, ingest_ontology
...
from reasongraph.ingest import ingest_ontology as _ingest_ontology, OntologyData
...
def ingest_ontology(
    ...
    **kwargs
    ...
    This is a convenience wrapper around reasongraph.ingest.ingest_ontology.
