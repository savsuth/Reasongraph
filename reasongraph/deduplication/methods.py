...
Example Usage:
    >>> from reasongraph.deduplication.methods import detect_duplicates, calculate_similarity
...
def list_available_methods(task: Optional[str] = None) -> Dict[str, List[str]]:
    ...
    Examples:
        >>> from reasongraph.deduplication.methods import list_available_methods
