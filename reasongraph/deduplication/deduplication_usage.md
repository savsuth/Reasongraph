...
```python
from reasongraph.deduplication import SimilarityCalculator
...
```python
from reasongraph.deduplication.methods import calculate_similarity
...
```python
from reasongraph.deduplication.methods import detect_duplicates
...
```python
from reasongraph.deduplication.methods import merge_entities
...
```python
from reasongraph.deduplication import EntityMerger, MergeStrategy
...
```python
from reasongraph.deduplication import MergeStrategyManager, MergeStrategy
...
```python
from reasongraph.deduplication.methods import build_clusters
...
```python
from reasongraph.deduplication import ClusterBuilder
...
```python
from reasongraph.deduplication.methods import list_available_methods, get_deduplication_method
...
```python
from reasongraph.deduplication.registry import method_registry
...
# Use custom method
from reasongraph.deduplication.methods import get_deduplication_method
...
```python
from reasongraph.deduplication.config import dedup_config
...
```python
from reasongraph.deduplication.config import DeduplicationConfig
...
```python
from reasongraph.deduplication import (
    DuplicateDetector,
    EntityMerger,
    MergeStrategy,
    ClusterBuilder
...
```python
from reasongraph.deduplication import EntityMerger
...
```python
from reasongraph.deduplication import MergeStrategyManager
