...
This module provides comprehensive lifecycle management for the Reasongraph framework,
...
class LifecycleManager:
    ...
    def startup(self) -> None:
        ...
        Raises:
            ReasongraphError: If startup fails (hook failure, component verification failure)
    ...
    def _execute_hooks(
        ...
        Raises:
            ReasongraphError: If hook fails and not graceful
        """
        ...
        for hook_fn, priority in sorted_hooks:
            try:
                ...
                if graceful:
                    ...
                    raise ReasongraphError(error_msg) from e
    ...
    def _verify_components(self) -> None:
        ...
        Raises:
            ReasongraphError: If components are not properly initialized
        """
        uninitialized = []
