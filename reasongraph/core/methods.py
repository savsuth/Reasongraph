...
Example Usage:
    >>> from reasongraph.core.methods import build_knowledge_base, get_orchestration_method
...
from .orchestrator import Reasongraph
...
def build_knowledge_base(
    ...
    **kwargs,
    ...
    # Use default Reasongraph framework
...
def initialize_framework(
    ...
    **kwargs,
    ...
    """
    Initialize Reasongraph framework (convenience function).
    ...
    framework = Reasongraph(config=config, **kwargs)
...
def get_status(
    framework: Optional[Reasongraph] = None, method: str = "default", **kwargs
) -> Dict[str, Any]:
    """
