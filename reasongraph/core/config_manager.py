...
This module provides comprehensive configuration management for the Reasongraph framework,
...
Supported Configuration Sources:
    ...
    - Environment variables: REASONGRAPH_ prefix for automatic loading
...
Key Features:
    ...
    - Environment variable support with REASONGRAPH_ prefix
...
class Config:
    ...
    def _load_from_env(self, config_dict: Dict[str, Any]) -> None:
        ...
        Environment variables with prefix REASONGRAPH_ will override configuration
        values. The format is: REASONGRAPH_SECTION_KEY=value

        Examples:
            REASONGRAPH_PROCESSING_BATCH_SIZE=64
            REASONGRAPH_LLM_PROVIDER_MODEL=gpt-4
            REASONGRAPH_QUALITY_MIN_CONFIDENCE=0.8
    ...
    def _normalize_env_key(self, env_key: str, prefix: str) -> str:
        ...
        Args:
            env_key: Environment variable key (e.g., "REASONGRAPH_PROCESSING_BATCH_SIZE")
            prefix: Prefix to remove (e.g., "REASONGRAPH_")
...
class ConfigManager:
    ...
    configuration for the Reasongraph framework. It supports multiple configuration
    sources and formats.
