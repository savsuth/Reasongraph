...
class ContextRetriever:
    ...
    def _generate_reasoned_response(
        ...
        Args:
            ...
            llm_provider: LLM provider instance (from reasongraph.llms)
...
class TemporalGraphRetriever:
    ...
    :meth:`~reasongraph.kg.temporal_query.TemporalGraphQuery.reconstruct_at_time`.
    ...
    Example::
        ...
        from reasongraph.context import ContextRetriever, TemporalGraphRetriever
    ...
    def __init__(
        ...
        Args:
            ...
            at_time: Default point-in-time for temporal filtering. Accepts a
                ...
                :func:`~reasongraph.kg.temporal_model.parse_temporal_value`
        ...
        if not _TEMPORAL_AVAILABLE:
            raise ImportError(
                "TemporalGraphRetriever requires the reasongraph.kg temporal modules "
