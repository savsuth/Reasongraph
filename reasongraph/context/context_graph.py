...
def _parse_iso_dt(value: str) -> Optional[datetime]:
    ...
    try:
        ...
        logging.getLogger("reasongraph.context").warning(
...
class ContextGraph:
    ...
    def to_kg_dict(self, entities_only: bool = False) -> Dict[str, Any]:
        ...
        :class:`~reasongraph.export.rdf_exporter.RDFExporter` and
        :meth:`~reasongraph.kg.temporal_query.TemporalGraphQuery.query_time_range`.
