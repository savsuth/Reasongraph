...
Example Usage:
    >>> from reasongraph.context import DecisionQuery
...
class DecisionQuery:
    ...
    def __init__(
        ...
        Args:
            ...
            advanced_analytics: Enable advanced graph analytics (requires reasongraph.kg)
            node_embeddings: Enable Node2Vec embeddings (requires reasongraph.kg)
            centrality_analysis: Enable centrality measures (requires reasongraph.kg)
            community_detection: Enable community detection (requires reasongraph.kg)
            link_prediction: Enable link prediction (requires reasongraph.kg)
        """
