...
provenance tracking from multiple Reasongraph modules:
...
# with RDFExporter's NamespaceManager "reasongraph" entry (reasongraph/export/
...
# placeholder domains.
DEFAULT_BASE_URI = "https://reasongraph.dev/ns#"
...
class ProvenanceManager:
    ...
    def _resolve_agent_kwargs(kwargs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        dataclass default "reasongraph" regardless of what callers passed.
        """
        ...
        return {
            "agent_id": kwargs.get("agent_id", "reasongraph"),
    ...
    def export_prov(self, format: str = "turtle", base_uri: Optional[str] = None) -> str:
        ...
        Args:
            ...
            base_uri: Namespace URI entities/agents/activities are minted
                ...
                "reasongraph" entry so KG-exported and PROV-exported URIs for
