...
the Reasongraph framework, providing type safety, interface definitions, and
...
Example Usage:
    >>> from reasongraph.utils import Entity, EntityType, Relationship, RelationshipType
    >>> entity = Entity(
    ...     id="e1",
    ...     text="John Doe",
    ...
    ... )
    >>> 
    >>> from reasongraph.utils import Result, BatchResult
