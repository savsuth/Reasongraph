...
This module provides comprehensive logging utilities for the Reasongraph framework,
...
Example Usage:
    ...
    >>> 
    >>> from reasongraph.utils import log_performance, log_error
...
def setup_logging(config: Optional[Dict[str, Any]] = None, **kwargs) -> logging.Logger:
    """
    Setup logging configuration for Reasongraph framework.
    ...
    log_file = config.get("file", "reasongraph.log")
    ...
    root_logger = logging.getLogger("reasongraph")
...
def get_logger(
    ...
    Returns:
        Logger instance
    """
    logger = logging.getLogger(f"reasongraph.{name}")
