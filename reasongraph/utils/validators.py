...
This module provides common validation functions used across the Reasongraph framework
...
Example Usage:
    >>> from reasongraph.utils import validate_data, validate_entity
    ...
    >>> 
    >>> from reasongraph.utils import validate_url, validate_file_path
