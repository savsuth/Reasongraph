...
This module provides comprehensive exception handling for the Reasongraph framework,
...
Key Features:
    - Custom exception hierarchy with base ReasongraphError class
...
Main Classes:
    - ReasongraphError: Base exception class for all framework errors
...
Example Usage:
    >>> from reasongraph.utils import ValidationError, ProcessingError
    >>> try:
    ...     if not is_valid:
    ...
    >>> 
    >>> from reasongraph.utils import handle_exception, format_exception
    >>> try:
    ...     process_data(data)
...
class ReasongraphError(Exception):
    """
    Base exception class for all Reasongraph framework errors.
...
class ValidationError(ReasongraphError):
    """
...
class ProcessingError(ReasongraphError):
    """
...
class ConfigurationError(ReasongraphError):
    """
...
class QualityError(ReasongraphError):
    """
...
def handle_exception(
    ...
    if isinstance(exception, ReasongraphError):
