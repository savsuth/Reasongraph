...
This module provides constants and configuration values for the Reasongraph framework,
...
Example Usage:
    >>> from reasongraph.utils import SUPPORTED_DOCUMENT_FORMATS, DEFAULT_CONFIG
    ...
    >>>
    >>> from reasongraph.utils import ERROR_CODES, PERFORMANCE_THRESHOLDS
...
# API Endpoints
API_ENDPOINTS = {
    "BASE_URL": "https://api.reasongraph.dev",
    "VERSION": "v1",
    "ENDPOINTS": {
        "PROCESS": "/process",
        "EXTRACT": "/extract",
