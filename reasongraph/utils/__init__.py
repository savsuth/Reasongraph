...
This module provides shared utilities and helper functions for the Reasongraph framework,
...
Main Classes:
    ...
    - Exception classes: ReasongraphError, ValidationError, ProcessingError, ConfigurationError, QualityError
...
Example Usage:
    ...
    >>> 
    >>> from reasongraph.utils import ValidationError, validate_entity
    >>> entity = {"id": "e1", "text": "John Doe", "type": "PERSON"}
    >>> is_valid, error = validate_entity(entity)
    >>> 
    >>> from reasongraph.utils import clean_text, merge_dicts
