...
Reasongraph framework, supporting multiple predefined color schemes and dynamic color generation
...
Example Usage:
    >>> from reasongraph.visualization.utils import ColorPalette, ColorScheme, get_color_scheme
