...
Example Usage:
    >>> from reasongraph.parse.methods import parse_document, parse_web_content, parse_json
...
def parse_document(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_document
        >>> doc = parse_document("document.pdf", method="default")
...
def parse_document_docling(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_document_docling
...
def parse_web_content(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_web_content
        >>> web = parse_web_content("https://example.com", method="default")
...
def parse_structured_data(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_structured_data
...
def parse_email(
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_email
...
def parse_code(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_code
...
def parse_media(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_media
...
def parse_pdf(
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_pdf
...
def parse_docx(
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_docx
...
def parse_json(file_path: Union[str, Path], method: str = "default", **kwargs) -> Any:
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_json
...
def parse_csv(
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_csv
...
def parse_xml(file_path: Union[str, Path], method: str = "default", **kwargs) -> Any:
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_xml
...
def parse_image(
    ...
    Examples:
        >>> from reasongraph.parse.methods import parse_image
