...
Reasongraph framework, enabling standardization of named entities and proper nouns
...
class EntityNormalizer:
    ...
    def normalize_entity(
        ...
        **options,
        ...
        tracking_id = self.progress_tracker.start_tracking(
            message="Reasongraph: Normalizing entity", file=None
        )
        try:
            if not entity_name:
    ...
    def resolve_aliases(self, entity_name: str, **context) -> Optional[str]:
        ...
        """
        tracking_id = self.progress_tracker.start_tracking(
            message="Reasongraph: Resolving aliases", file=None
        )
        try:
    ...
    def disambiguate_entity(self, entity_name: str, **context) -> Dict[str, Any]:
        ...
        """
        tracking_id = self.progress_tracker.start_tracking(
            message="Reasongraph: Disambiguating entity", file=None
        )
        try:
    ...
    def link_entities(self, entities: List[str], **options) -> Dict[str, str]:
        ...
        """
        tracking_id = self.progress_tracker.start_tracking(
            message="Reasongraph: Linking entities", file=None
        )
        try:
            linked = {}
