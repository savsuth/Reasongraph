...
Example Usage:
    >>> from reasongraph.normalize.methods import normalize_text, normalize_entity, normalize_date
...
def normalize_text(text: str, method: str = "default", **kwargs) -> str:
    ...
    Examples:
        >>> from reasongraph.normalize.methods import normalize_text
...
def clean_text(text: str, method: str = "default", **kwargs) -> str:
    ...
    Examples:
        >>> from reasongraph.normalize.methods import clean_text
...
def normalize_entity(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.normalize.methods import normalize_entity
...
def resolve_aliases(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.normalize.methods import resolve_aliases
...
def disambiguate_entity(
    ...
    Examples:
        >>> from reasongraph.normalize.methods import disambiguate_entity
...
def normalize_date(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.normalize.methods import normalize_date
...
def normalize_time(time_input: Any, method: str = "default", **kwargs) -> str:
    ...
    Examples:
        >>> from reasongraph.normalize.methods import normalize_time
...
def normalize_number(
    ...
    Examples:
        >>> from reasongraph.normalize.methods import normalize_number
...
def normalize_quantity(
    ...
    Examples:
        >>> from reasongraph.normalize.methods import normalize_quantity
...
def clean_data(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.normalize.methods import clean_data
...
def detect_duplicates(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.normalize.methods import detect_duplicates
...
def detect_language(
    ...
    Examples:
        >>> from reasongraph.normalize.methods import detect_language
...
def handle_encoding(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.normalize.methods import handle_encoding
