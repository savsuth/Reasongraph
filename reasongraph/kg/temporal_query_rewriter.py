...
components (e.g. :class:`~reasongraph.context.context_retriever.TemporalGraphRetriever`)
...
class TemporalQueryRewriter:
    ...
    **Regex-only** (default, no LLM required)
        ...
        :class:`~reasongraph.kg.temporal_normalizer.TemporalNormalizer`
    ...
    **LLM-assisted** (``llm_provider`` kwarg)
        ...
        :class:`~reasongraph.kg.temporal_normalizer.TemporalNormalizer` so the
    ...
    .. warning::
        ...
        performed by
        :class:`~reasongraph.context.context_retriever.TemporalGraphRetriever`.
    """
