...
Note: Conflict detection and deduplication have been moved to dedicated modules.
    Use reasongraph.conflicts for conflict detection and reasongraph.deduplication for deduplication.

Example Usage:
    >>> from reasongraph.kg.methods import build_kg, analyze_graph, calculate_centrality
...
def analyze_graph(
    ...
    Examples:
        >>> from reasongraph.kg.methods import analyze_graph
        >>> analysis = analyze_graph(kg, method="default")
...
def resolve_entities(
    ...
    Examples:
        >>> from reasongraph.kg.methods import resolve_entities
...
def calculate_centrality(
    ...
    Examples:
        >>> from reasongraph.kg.methods import calculate_centrality
...
def detect_communities(
    ...
    Examples:
        >>> from reasongraph.kg.methods import detect_communities
...
def analyze_connectivity(
    ...
    Examples:
        >>> from reasongraph.kg.methods import analyze_connectivity
...
def query_temporal(
    ...
    Examples:
        >>> from reasongraph.kg.methods import query_temporal
...
def calculate_similarity(
    ...
    Examples:
        >>> from reasongraph.kg.methods import calculate_similarity
...
def predict_links(
    ...
    **kwargs
    ...
    Examples:
        >>> from reasongraph.kg.methods import predict_links
        >>> links = predict_links(
        ...     graph_store,
...
def find_shortest_path(
    ...
    **kwargs
    ...
    Examples:
        >>> from reasongraph.kg.methods import find_shortest_path
...
def calculate_pagerank(
    ...
    **kwargs
    ...
    Examples:
        >>> from reasongraph.kg.methods import calculate_pagerank
...
def detect_communities_label_propagation(
    ...
    **kwargs
    ...
    Examples:
        >>> from reasongraph.kg.methods import detect_communities_label_propagation
