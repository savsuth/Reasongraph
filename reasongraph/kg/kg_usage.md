...
Note: For conflict detection and resolution, use the `reasongraph.conflicts` module.
For deduplication, use the `reasongraph.deduplication` module.
...
```python
from reasongraph.kg import GraphBuilder, GraphAnalyzer, NodeEmbedder, SimilarityCalculator, PathFinder, LinkPredictor
...
# For advanced conflict resolution, consider using the reasongraph.conflicts module directly.
builder = GraphBuilder(
    merge_entities=True,
    entity_resolution_strategy="fuzzy",
    resolve_conflicts=True,
...
```python
from reasongraph.kg import algorithm_registry
...
```python
from reasongraph.kg import NodeEmbedder
...
```python
from reasongraph.kg import GraphAnalyzer
...
```python
from reasongraph.kg import GraphAnalyzer, CentralityCalculator
...
```python
from reasongraph.kg import GraphAnalyzer, CentralityCalculator, CommunityDetector, ConnectivityAnalyzer
...
```python
from reasongraph.kg import EntityResolver
...
```python
from reasongraph.kg import analyze_connectivity, ConnectivityAnalyzer
...
```python
from reasongraph.kg import analyze_connectivity
...
```python
from reasongraph.kg.methods import (
    build_kg,
    analyze_graph,
    resolve_entities,
    detect_conflicts,
...
```python
from reasongraph.kg.methods import get_kg_method
...
```python
from reasongraph.kg.methods import list_available_methods
...
```python
from reasongraph.kg.registry import method_registry
...
# Use custom method
from reasongraph.kg.methods import build_kg
...
```python
from reasongraph.kg.registry import algorithm_registry
...
from reasongraph.kg.methods import compute_node_embeddings
...
```python
from reasongraph.kg.registry import method_registry, algorithm_registry
...
```python
from reasongraph.kg.config import kg_config
...
```python
from reasongraph.kg.config import KGConfig
