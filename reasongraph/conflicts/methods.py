...
Example Usage:
    >>> from reasongraph.conflicts.methods import detect_conflicts, resolve_conflicts
    >>> conflicts = detect_conflicts(entities, method="value", property_name="name")
    >>> results = resolve_conflicts(conflicts, method="voting")
    >>> from reasongraph.conflicts.methods import get_conflict_method
...
def detect_conflicts(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.conflicts.methods import detect_conflicts
        >>> entities = [
...
def resolve_conflicts(
    ...
    Examples:
        >>> from reasongraph.conflicts.methods import resolve_conflicts
        >>> conflicts = detect_conflicts(entities, method="value", property_name="name")
        >>> results = resolve_conflicts(conflicts, method="voting")
...
def analyze_conflicts(
    ...
    Examples:
        >>> from reasongraph.conflicts.methods import analyze_conflicts
        >>> conflicts = detect_conflicts(entities, method="value", property_name="name")
...
def track_sources(
    ...
    **kwargs,
    ...
    Examples:
        >>> from reasongraph.conflicts.methods import track_sources
        >>> from reasongraph.conflicts import SourceReference
...
def generate_investigation_guide(
    ...
    Examples:
        >>> from reasongraph.conflicts.methods import generate_investigation_guide
        >>> conflicts = detect_conflicts(entities, method="value", property_name="name")
...
def list_available_methods(task: Optional[str] = None) -> Dict[str, List[str]]:
    ...
    Examples:
        >>> from reasongraph.conflicts.methods import list_available_methods
