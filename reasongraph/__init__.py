...
Main exports:
    - Reasongraph: Main framework class
    - PipelineBuilder: Pipeline construction DSL
    - Config: Configuration management
"""

__version__ = "0.6.5"
__author__ = "Aasav Suthar"
__license__ = "MIT"
...
# Core imports
# from .core import Config, ConfigManager, LifecycleManager, PluginRegistry, Reasongraph
...
class _ModuleProxy:
    ...
    def _get_module(self):
        ...
        if self._module is None:
            self._module = importlib.import_module(f"reasongraph.{self._module_name}")
        return self._module
...
def __getattr__(name: str):
    ...
    raise AttributeError(f"module 'reasongraph' has no attribute '{name}'")
