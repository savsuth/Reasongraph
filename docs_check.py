...
def _() -> list[str]:
    stale = ["Hawksight-AI/reasongraph", "reasongraph-dev/reasongraph"]
...
def _() -> list[str]:
    modules = [
        "reasongraph.ingest", "reasongraph.parse", "reasongraph.split", "reasongraph.normalize",
        "reasongraph.semantic_extract", "reasongraph.kg", "reasongraph.ontology", "reasongraph.reasoning",
        "reasongraph.embeddings", "reasongraph.vector_store", "reasongraph.graph_store",
        "reasongraph.triplet_store", "reasongraph.context", "reasongraph.provenance",
        "reasongraph.change_management", "reasongraph.deduplication", "reasongraph.conflicts",
        "reasongraph.export", "reasongraph.visualization", "reasongraph.pipeline", "reasongraph.seed",
        "reasongraph.llms", "reasongraph.mcp_server", "reasongraph.explorer", "reasongraph.evals",
        "reasongraph.utils", "reasongraph.core",
    ]
