...
from reasongraph.semantic_extract.triplet_extractor import (
    TripletExtractor, 
    TripletValidator, 
...
from reasongraph.semantic_extract.methods import get_entity_method, get_relation_method
...
class TestSemanticExtractDeepDive(unittest.TestCase):
    ...
    def test_named_entity_recognizer_flow(self):
        ...
        with patch('reasongraph.semantic_extract.methods.get_entity_method') as mock_get:
    ...
    def test_triplet_extractor(self):
        ...
        with patch('reasongraph.semantic_extract.methods.get_triplet_method') as mock_get:
