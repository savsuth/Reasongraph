...
_SCRIPT = textwrap.dedent(
    ...
    decision_ctx = ReasongraphDecisionTool()
    decision_tool = ReasongraphDecisionTool(context=decision_ctx.context)
    ...
    assert kg_dump["name"] == "reasongraph_knowledge_graph", kg_dump["name"]
    restored = ReasongraphKGTool.model_validate(kg_dump)
    ...
    ks = ReasongraphKnowledgeSource(graph=graph)
