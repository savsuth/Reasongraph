...
# --- ReasongraphKnowledgeSource: importable + functional without crewai --------
src = ReasongraphKnowledgeSource(graph=graph, chunk_size=40, chunk_overlap=5)
...
# --- ReasongraphDecisionTool: importable, builds its own context --------------
dt = ReasongraphDecisionTool()
assert dt.name == "reasongraph_decision"
