...
class TestArrowExporter(unittest.TestCase):
        ...
        with patch.dict('sys.modules', {'pyarrow': None}):
            ...
            if not ARROW_AVAILABLE:
                with self.assertRaises(ImportError):
                    from reasongraph.export.arrow_exporter import ArrowExporter as TestExporter
    ...
    def test_export_entities_basic(self):
        ...
        with pa.OSFile(str(output_path), 'rb') as source:
            with ipc.open_file(source) as reader:
                ...
                # Verify schema
                from reasongraph.export.arrow_exporter import ENTITY_SCHEMA
    ...
    def test_schema_validation(self):
        ...
        from reasongraph.export.arrow_exporter import ENTITY_SCHEMA, RELATIONSHIP_SCHEMA
