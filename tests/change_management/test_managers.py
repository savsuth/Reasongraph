...
import pytest
from reasongraph.change_management import (
    TemporalVersionManager,
    OntologyVersionManager,
    ChangeLogEntry
)
from reasongraph.change_management.change_log import generate_change_report, ChangeLogAnalyzer
from reasongraph.change_management.ontology_version_manager import VersionManager
