...
from reasongraph.ingest import MCPIngestor, ingest_mcp, DBIngestor, FileIngestor
from reasongraph.ingest.mcp_ingestor import MCPData
...
class TestCookbookIntegration:
    ...
    def test_financial_data_integration(self, mock_mcp_server):
        ...
        with patch("reasongraph.ingest.mcp_ingestor.get_progress_tracker") as mock_tracker:
