...
from reasongraph.ingest.web_ingestor import (
    ContentExtractor,
    ProcessingError,
    RateLimiter,
    RobotsChecker,
...
@patch("reasongraph.ingest.web_ingestor.RobotFileParser")
...
def test_robots_checker_cache() -> None:
    ...
    with patch("reasongraph.ingest.web_ingestor.RobotFileParser") as mock_parser:
...
def test_web_ingestor_crawl_sitemap_integration() -> None:
    ...
    with patch(
        "reasongraph.ingest.web_ingestor.SitemapCrawler.parse_sitemap"
    ) as mock_parse:
