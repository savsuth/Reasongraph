...
from reasongraph.ingest.mcp_client import MCPClient
from reasongraph.ingest.public_api_ingestor import PublicAPIIngestor
from reasongraph.ingest.ssrf import request_with_ssrf_guard
...
class TestSessionHeadersStripping:
    ...
    @patch("reasongraph.ingest.ssrf.socket.getaddrinfo", side_effect=_public_getaddrinfo)
