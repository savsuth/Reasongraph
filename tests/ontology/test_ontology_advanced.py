...
from reasongraph.ontology.ontology_evaluator import OntologyEvaluator, EvaluationResult
from reasongraph.ontology.competency_questions import CompetencyQuestionsManager, CompetencyQuestion
from reasongraph.change_management import VersionManager, OntologyVersion
from reasongraph.ontology.associative_class import AssociativeClassBuilder, AssociativeClass
from reasongraph.ontology.reuse_manager import ReuseManager
...
class TestOntologyAdvanced(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patchers = [
            ...
            patch('reasongraph.ontology.competency_questions.get_logger', return_value=self.mock_logger),
            patch('reasongraph.ontology.competency_questions.get_progress_tracker', return_value=self.mock_tracker),
            ...
            patch('reasongraph.ontology.associative_class.get_logger', return_value=self.mock_logger),
            patch('reasongraph.ontology.associative_class.get_progress_tracker', return_value=self.mock_tracker),
        ]
    ...
    @patch('reasongraph.change_management.ontology_version_manager.NamespaceManager')
...
class TestSHACLHierarchicalAndValidation(unittest.TestCase):
    ...
    def test_engine_to_shacl_returns_non_empty_string(self):
        ...
        with patch("reasongraph.ontology.engine.get_logger", return_value=MagicMock()), \
             patch("reasongraph.ontology.engine.get_progress_tracker", return_value=mock_progress), \
             patch("reasongraph.ontology.ontology_generator.get_logger", return_value=MagicMock()), \
             patch("reasongraph.ontology.ontology_generator.get_progress_tracker", return_value=mock_progress):
            from reasongraph.ontology.engine import OntologyEngine
    ...
    def test_shacl_validation_report_summary_conforms(self):
        from reasongraph.ontology.ontology_validator import SHACLValidationReport
    ...
    def test_shacl_validation_report_summary_violations(self):
        from reasongraph.ontology.ontology_validator import (
    ...
    def test_shacl_violation_to_dict(self):
        from reasongraph.ontology.ontology_validator import SHACLViolation
        v = SHACLViolation(
