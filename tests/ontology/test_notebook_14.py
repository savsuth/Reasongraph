...
class TestNotebook14(unittest.TestCase):
    ...
    def _run_full_pipeline(self):
        ...
        engine = OntologyEngine(base_uri="https://docs.reasongraph.dev/ontology/")
    ...
    @patch("reasongraph.visualization.ontology_visualizer.make_subplots")
    @patch("reasongraph.visualization.ontology_visualizer.go")
    ...
    @patch("reasongraph.ontology.llm_generator.LLMOntologyGenerator.generate_ontology_from_text")
