...
class TestDatabricksConnector:
    ...
    @patch("reasongraph.ingest.databricks_ingestor.DATABRICKS_AVAILABLE", True)
    @patch("reasongraph.ingest.databricks_ingestor.databricks_sql")
    def test_connector_init_with_token(self, mock_sql):
        """Test connector initialization with personal access token authentication."""
        from reasongraph.ingest.databricks_ingestor import DatabricksConnector
    ...
    def test_connector_init_missing_host(self, mock_sql):
        ...
        from reasongraph.ingest.databricks_ingestor import DatabricksConnector
        from reasongraph.utils.exceptions import ValidationError
    ...
    @patch("reasongraph.ingest.databricks_ingestor.DATABRICKS_AVAILABLE", True)
    @patch("reasongraph.ingest.databricks_ingestor.oauth_service_principal")
    @patch("reasongraph.ingest.databricks_ingestor.Config")
    @patch("reasongraph.ingest.databricks_ingestor.databricks_sql")
...
class TestDatabricksIngestor:
    ...
    def test_ingestor_init(self, mock_sql):
        ...
        from reasongraph.ingest.databricks_ingestor import DatabricksIngestor
    ...
    @patch("reasongraph.ingest.databricks_ingestor.DATABRICKS_AVAILABLE", True)
    @patch("reasongraph.ingest.databricks_ingestor.databricks_sql")
    @patch("reasongraph.ingest.databricks_ingestor.WorkspaceClient")
    ...
    def test_export_as_documents(self, mock_sql):
        ...
        from reasongraph.ingest.databricks_ingestor import DatabricksData, DatabricksIngestor
    ...
    def test_import_error_without_databricks(self):
        ...
        with patch("reasongraph.ingest.databricks_ingestor.DATABRICKS_AVAILABLE", False):
            from reasongraph.ingest.databricks_ingestor import DatabricksConnector
...
class TestDatabricksData:
    ...
    def test_databricks_data_creation(self):
        ...
        from reasongraph.ingest.databricks_ingestor import DatabricksData
