...
sys.modules['reasongraph.semantic_extract.methods'] = MagicMock()
sys.modules['reasongraph.utils.logging'] = MagicMock()
sys.modules['reasongraph.utils.progress_tracker'] = MagicMock()
sys.modules['reasongraph.semantic_extract.providers'] = MagicMock()

# Mock get_logger and get_progress_tracker
mock_logger = MagicMock()
sys.modules['reasongraph.utils.logging'].get_logger.return_value = mock_logger

mock_tracker = MagicMock()
sys.modules['reasongraph.utils.progress_tracker'].get_progress_tracker.return_value = mock_tracker

# Mock the methods module functions specifically
mock_methods = sys.modules['reasongraph.semantic_extract.methods']
