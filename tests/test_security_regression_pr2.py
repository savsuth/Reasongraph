...
class TestVuln2LinkPredictionDos:
    ...
    def test_constant_values_changed(self):
        ...
        import ast, pathlib
        src = pathlib.Path(
            "reasongraph/explorer/routes/enrich.py"
    ...
    def test_cap_constant_defined(self):
        ...
        from reasongraph.explorer.routes.enrich import _LINK_PREDICTION_MAX_NODES
    ...
    def test_semaphore_defined(self):
        ...
        import asyncio
        from reasongraph.explorer.routes.enrich import _link_prediction_semaphore
...
class TestVuln3ImportNodeIdSanitization:
    ...
    def test_import_sanitizer_applied_json(self):
        ...
        import ast, pathlib
        src = pathlib.Path(
            "reasongraph/explorer/routes/export_import.py"
        ).read_text(encoding="utf-8")
...
class TestVuln2CapEnforcedBeforeExpensiveWork:
    ...
    def test_predict_links_checks_raw_counts_before_get_nodes(self):
        ...
        src = pathlib.Path("reasongraph/explorer/routes/enrich.py").read_text(encoding="utf-8")
