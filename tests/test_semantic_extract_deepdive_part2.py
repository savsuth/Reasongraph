...
from reasongraph.semantic_extract.named_entity_recognizer import (
    NamedEntityRecognizer, EntityClassifier, EntityConfidenceScorer, CustomEntityDetector
)
from reasongraph.semantic_extract.ner_extractor import NERExtractor, Entity
from reasongraph.semantic_extract.relation_extractor import RelationExtractor, Relation
from reasongraph.semantic_extract.triplet_extractor import TripletExtractor, Triplet
from reasongraph.semantic_extract.event_detector import EventDetector, Event
from reasongraph.semantic_extract.semantic_analyzer import SemanticAnalyzer, SemanticRole
...
class TestSemanticExtractDeepDivePart2(unittest.TestCase):
    ...
    @patch("reasongraph.semantic_extract.methods.SPACY_AVAILABLE", False)
    @patch("reasongraph.semantic_extract.methods.extract_relations_pattern")
    ...
    def test_coreference_resolver_pronouns(self):
        ...
        from reasongraph.semantic_extract.coreference_resolver import CoreferenceResolver, Mention
