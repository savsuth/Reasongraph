...
class TestTemporalBoundSentinel:
    ...
    def setup_method(self):
        from reasongraph.kg.temporal_model import TemporalBound
...
class TestParseTemporalValue:
    ...
    def setup_method(self):
        from reasongraph.kg.temporal_model import parse_temporal_value
...
class TestParseTemporalBound:
    ...
    def setup_method(self):
        from reasongraph.kg.temporal_model import parse_temporal_bound, TemporalBound
...
class TestSerializeTemporalHelpers:
    ...
    def setup_method(self):
        from reasongraph.kg.temporal_model import (
...
class TestBiTemporalFact:
    ...
    def setup_method(self):
        from reasongraph.kg.temporal_model import BiTemporalFact, TemporalBound
