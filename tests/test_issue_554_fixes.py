...
from reasongraph.semantic_extract.providers import OpenAIProvider
...
class TestBug1ExcInfoOnMethodFailure(unittest.TestCase):
    ...
    def test_traceback_logged_on_llm_failure(self, mock_create):
        ...
        with self.assertLogs("reasongraph.ner_extractor", level="WARNING") as log_ctx:
    ...
    def test_fallback_to_pattern_on_llm_failure(self, mock_create):
        ...
        with self.assertLogs("reasongraph.ner_extractor", level="WARNING"):
    ...
    @patch("reasongraph.semantic_extract.methods.EntitiesResponse",
           _StubEntitiesResponse, create=True)
    @patch("reasongraph.semantic_extract.methods.SCHEMAS_AVAILABLE", True)
    @patch("reasongraph.semantic_extract.methods.create_provider")
...
class TestBug3GenerateTypedFallbackToPlainGenerate(unittest.TestCase):
    ...
    def test_generate_structured_fallback_warning_has_exc_info(self):
        ...
        with self.assertLogs("reasongraph.test_provider", level="WARNING") as log_ctx:
            provider.generate_typed(
