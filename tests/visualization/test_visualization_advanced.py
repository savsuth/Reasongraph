...
class TestVisualizationAdvanced(unittest.TestCase):
    ...
    def test_visualize_2d_projection(self):
        ...
        # Mock UMAP/TSNE/PCA
        with patch('reasongraph.visualization.embedding_visualizer.umap') as mock_umap, \
             patch('reasongraph.visualization.embedding_visualizer.TSNE') as mock_tsne, \
             patch('reasongraph.visualization.embedding_visualizer.PCA') as mock_pca:
