...
class TestOptionalDependencies(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.viz_modules = [
            'reasongraph.visualization.embedding_visualizer',
            'reasongraph.visualization.ontology_visualizer',
            'reasongraph.visualization.kg_visualizer',
            'reasongraph.visualization.utils.export_formats'
        ]
    ...
    def test_ontology_visualizer_without_graphviz(self):
        ...
        with patch.dict(sys.modules, {'graphviz': None}):
            from reasongraph.visualization.ontology_visualizer import OntologyVisualizer, ProcessingError
    ...
    def test_analytics_visualizer_without_plotly(self):
        ...
        with patch.dict(sys.modules, {'plotly': None, 'plotly.express': None, 'plotly.graph_objects': None}):
            from reasongraph.visualization.analytics_visualizer import AnalyticsVisualizer, ProcessingError
    ...
    def test_semantic_network_visualizer_without_plotly(self):
        ...
        with patch.dict(sys.modules, {'plotly': None, 'plotly.express': None, 'plotly.graph_objects': None}):
            from reasongraph.visualization.semantic_network_visualizer import SemanticNetworkVisualizer, ProcessingError
    ...
    def test_temporal_visualizer_without_plotly(self):
        ...
        with patch.dict(sys.modules, {'plotly': None, 'plotly.express': None, 'plotly.graph_objects': None}):
            from reasongraph.visualization.temporal_visualizer import TemporalVisualizer, ProcessingError
