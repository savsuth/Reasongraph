...
class TestVisualization(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger_patcher = patch('reasongraph.visualization.kg_visualizer.get_logger', return_value=self.mock_logger)
        self.tracker_patcher = patch('reasongraph.visualization.kg_visualizer.get_progress_tracker', return_value=self.mock_tracker)
        
        self.logger_patcher_ov = patch('reasongraph.visualization.ontology_visualizer.get_logger', return_value=self.mock_logger)
        self.tracker_patcher_ov = patch('reasongraph.visualization.ontology_visualizer.get_progress_tracker', return_value=self.mock_tracker)
    ...
    @patch('reasongraph.visualization.kg_visualizer.ForceDirectedLayout')
    @patch('reasongraph.visualization.kg_visualizer.HierarchicalLayout')
    @patch('reasongraph.visualization.kg_visualizer.CircularLayout')
