...
# Import visualizers
from reasongraph.visualization.kg_visualizer import KGVisualizer
from reasongraph.visualization.ontology_visualizer import OntologyVisualizer
from reasongraph.visualization.embedding_visualizer import EmbeddingVisualizer
from reasongraph.visualization.semantic_network_visualizer import SemanticNetworkVisualizer
from reasongraph.visualization.analytics_visualizer import AnalyticsVisualizer
from reasongraph.visualization.temporal_visualizer import TemporalVisualizer
from reasongraph.visualization.utils.color_schemes import ColorScheme
...
class TestVisualizationComprehensive(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patchers = [
            patch('reasongraph.visualization.kg_visualizer.get_logger', return_value=self.mock_logger),
            patch('reasongraph.visualization.kg_visualizer.get_progress_tracker', return_value=self.mock_tracker),
            patch('reasongraph.visualization.ontology_visualizer.get_logger', return_value=self.mock_logger),
            patch('reasongraph.visualization.ontology_visualizer.get_progress_tracker', return_value=self.mock_tracker),
            patch('reasongraph.visualization.embedding_visualizer.get_logger', return_value=self.mock_logger),
            patch('reasongraph.visualization.embedding_visualizer.get_progress_tracker', return_value=self.mock_tracker),
            patch('reasongraph.visualization.semantic_network_visualizer.get_logger', return_value=self.mock_logger),
            patch('reasongraph.visualization.semantic_network_visualizer.get_progress_tracker', return_value=self.mock_tracker),
            patch('reasongraph.visualization.analytics_visualizer.get_logger', return_value=self.mock_logger),
            patch('reasongraph.visualization.analytics_visualizer.get_progress_tracker', return_value=self.mock_tracker),
            patch('reasongraph.visualization.temporal_visualizer.get_logger', return_value=self.mock_logger),
            patch('reasongraph.visualization.temporal_visualizer.get_progress_tracker', return_value=self.mock_tracker),
            # Mock Layouts
            patch('reasongraph.visualization.kg_visualizer.ForceDirectedLayout', MagicMock()),
            patch('reasongraph.visualization.kg_visualizer.HierarchicalLayout', MagicMock()),
            patch('reasongraph.visualization.kg_visualizer.CircularLayout', MagicMock()),
            patch('reasongraph.visualization.ontology_visualizer.HierarchicalLayout', MagicMock()),
            patch('reasongraph.visualization.semantic_network_visualizer.ForceDirectedLayout', MagicMock()),
        ]
    ...
    def test_semantic_network_visualizer(self):
        ...
        # Test visualize_network
        with patch('reasongraph.visualization.kg_visualizer.KGVisualizer') as MockKG:
    ...
    def test_embedding_visualizer(self):
        ...
        with patch('reasongraph.visualization.embedding_visualizer.umap.UMAP') as MockUMAP:
