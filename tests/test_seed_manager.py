...
from reasongraph.seed.seed_manager import SeedDataManager, SeedDataSource, SeedData
...
@patch("reasongraph.ingest.db_ingestor.DBIngestor")
...
def test_load_from_database_os_error_not_misreported(seed_manager):
    ...
    import reasongraph.ingest.db_ingestor as dbi
...
def test_load_from_database_import_error(seed_manager):
    with patch.dict("sys.modules", {"reasongraph.ingest.db_ingestor": None}):
...
@patch("reasongraph.seed.seed_manager.request_with_ssrf_guard")
