...
from reasongraph.triplet_store.rdf4j_store import RDF4JStore
...
class TestRDF4JStoreExecuteSparqlConstructPath(unittest.TestCase):
    def test_construct_sends_turtle_accept_header(self):
        ...
        with patch("reasongraph.triplet_store.rdf4j_store.requests.post",
    ...
    def test_construct_parses_triples_from_turtle_fixture(self):
        ...
        mock_resp.raise_for_status = MagicMock()
        with patch("reasongraph.triplet_store.rdf4j_store.requests.post", return_value=mock_resp):
...
class TestRDF4JStoreQodoBugfixes(unittest.TestCase):
    ...
    def test_execute_sparql_validates_result_format(self):
        ...
        with patch("reasongraph.triplet_store.rdf4j_store.requests.post", return_value=mock_resp_c):
