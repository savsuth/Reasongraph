...
from reasongraph.triplet_store.jena_store import JenaStore
...
from reasongraph.triplet_store.construct_templates import execute_construct_template, ConstructTemplate
...
class TestJenaStoreRemoteEndpointUsesUpdateStore(unittest.TestCase):
    ...
    def _make_remote_store(self):
        ...
        with patch(
            "reasongraph.triplet_store.jena_store.SPARQLUpdateStore",
        ) as MockUpdateStore:
            ...
            with patch("reasongraph.triplet_store.jena_store.Graph") as MockGraph:
    ...
    def test_remote_endpoint_instantiates_sparql_update_store_not_sparql_store(self):
        ...
        with patch(
            ...
            "reasongraph.triplet_store.jena_store.SPARQLStore"
        ) as MockReadOnlyStore:
            MockUpdateStore.return_value = MagicMock()
            with patch("reasongraph.triplet_store.jena_store.Graph"):
    ...
    def test_remote_endpoint_derives_fuseki_query_and_update_sub_paths(self):
        ...
        with patch(
            "reasongraph.triplet_store.jena_store.SPARQLUpdateStore"
        ) as MockUpdateStore, patch("reasongraph.triplet_store.jena_store.Graph"):
            MockUpdateStore.return_value = MagicMock()
    ...
    def test_add_triplets_remote_endpoint_fires_insert_data_via_update_store(self):
        ...
        with patch(
            ...
            "reasongraph.triplet_store.jena_store.Dataset"
        ) as MockDataset:
...
class TestJenaStoreEndpointDerivation(unittest.TestCase):
    ...
    def test_bare_base_url_appends_query_and_update(self):
        ...
        with patch(
            "reasongraph.triplet_store.jena_store.SPARQLUpdateStore"
        ) as MockUS, patch("reasongraph.triplet_store.jena_store.Dataset"):
