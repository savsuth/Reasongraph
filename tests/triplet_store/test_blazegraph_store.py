...
from reasongraph.triplet_store.blazegraph_store import BlazegraphStore
...
from reasongraph.triplet_store import sparql_escaping
...
class TestBlazegraphStoreConstructExtension(unittest.TestCase):
    ...
    def test_execute_sparql_construct_sends_turtle_accept_header(self):
        ...
        with patch("reasongraph.triplet_store.blazegraph_store.requests.post", return_value=mock_response) as mock_post:
    ...
    def test_execute_sparql_construct_parses_triples_from_fixed_turtle_fixture(self):
        ...
        with patch("reasongraph.triplet_store.blazegraph_store.requests.post", return_value=mock_response):
