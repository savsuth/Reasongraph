...
from reasongraph.triplet_store.triplet_store import TripletStore
from reasongraph.triplet_store.query_engine import QueryEngine
...
class TestTripletStore(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger_patcher = patch('reasongraph.triplet_store.triplet_store.get_logger', return_value=self.mock_logger)
        self.tracker_patcher = patch('reasongraph.triplet_store.triplet_store.get_progress_tracker', return_value=self.mock_tracker)
    ...
    @patch('reasongraph.triplet_store.blazegraph_store.BlazegraphStore')
...
class TestSKOSTripletStore(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger_patcher = patch(
            'reasongraph.triplet_store.triplet_store.get_logger', return_value=self.mock_logger
        )
        self.tracker_patcher = patch(
            'reasongraph.triplet_store.triplet_store.get_progress_tracker', return_value=self.mock_tracker
        )
        self.logger_patcher.start()
        self.tracker_patcher.start()
    ...
    def test_get_skos_concepts_all(self, mock_bg):
        ...
        from reasongraph.triplet_store.query_engine import QueryResult
...
class TestTripletStoreOntologyNamespace(unittest.TestCase):
    ...
    def _make_store(self, mock_bg):
        ...
        with (
            patch("reasongraph.triplet_store.triplet_store.get_logger", return_value=MagicMock()),
            patch("reasongraph.triplet_store.triplet_store.get_progress_tracker", return_value=MagicMock()),
        ):
            store = TripletStore(backend="blazegraph")
