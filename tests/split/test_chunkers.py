...
from reasongraph.split.kg_chunkers import (
    EntityAwareChunker,
    GraphBasedChunker,
    HierarchicalChunker,
...
from reasongraph.split.sliding_window_chunker import SlidingWindowChunker
from reasongraph.split.structural_chunker import StructuralChunker, StructuralElement
from reasongraph.split.table_chunker import TableChunk, TableChunker
...
requires_semantic_extract = pytest.mark.skipif(
    ...
    reason="reasongraph.semantic_extract is not available",
)
...
class TestEntityAwareChunker:
    ...
    def test_entity_boundaries_preserved_with_pattern_ner(self):
        ...
        pytest.importorskip("reasongraph.semantic_extract")
