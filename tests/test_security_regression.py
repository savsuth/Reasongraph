...
# reasongraph/explorer/routes/sparql.py's actual behavior (the inlined
...
# of drift impossible.
from reasongraph.explorer.routes.sparql import _is_read_only_query
...
class TestCypherInjection:
    ...
    def test_sanitize_label_valid(self):
        from reasongraph.graph_store.age_store import _sanitize_label
    ...
    def test_value_to_cypher_literal_string_escaping(self):
        from reasongraph.graph_store.age_store import _value_to_cypher_literal
    ...
    def test_dollar_dollar_breakout_blocked(self):
        ...
        from reasongraph.graph_store.age_store import ApacheAgeStore
    ...
    def test_property_key_injection(self):
        from reasongraph.graph_store.age_store import _props_to_cypher_literal
        with pytest.raises(Exception):
...
class TestXXEProtection:
    ...
    def test_defusedxml_check_exists(self):
        ...
        from reasongraph.explorer.utils.rdf_parser import _HAS_DEFUSEDXML
        assert isinstance(_HAS_DEFUSEDXML, bool)

    def test_safe_parse_rdf_function_exists(self):
        """_safe_parse_rdf must be importable."""
        from reasongraph.explorer.utils.rdf_parser import _safe_parse_rdf
