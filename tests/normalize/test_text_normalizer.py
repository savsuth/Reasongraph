...
from reasongraph.normalize.text_normalizer import (
...
class TestTextNormalizer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger_patcher = patch("reasongraph.normalize.text_normalizer.get_logger")
        self.tracker_patcher = patch(
            "reasongraph.normalize.text_normalizer.get_progress_tracker"
        )
        self.cleaner_patcher = patch("reasongraph.normalize.text_normalizer.TextCleaner")
