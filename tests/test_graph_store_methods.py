...
from reasongraph.graph_store import methods
from reasongraph.graph_store.registry import method_registry
...
class TestGraphStoreMethods(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_store_patcher = patch('reasongraph.graph_store.methods.GraphStore', return_value=self.mock_store)
