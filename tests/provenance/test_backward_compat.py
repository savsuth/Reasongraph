...
Critical tests to ensure all existing Reasongraph code works unchanged
with the new unified provenance module.
"""

import pytest
from reasongraph.kg import ProvenanceTracker as KGProvenanceTracker
from reasongraph.split import ProvenanceTracker as SplitProvenanceTracker
...
class TestExistingTestsPass:
    """Verify that all existing Reasongraph tests still pass."""
