...
class TestProvenanceEnabledDisabled:
    ...
    def test_all_modules_support_provenance_false(self):
        ...
        modules_to_test = [
            ('reasongraph.context.context_provenance', 'ContextManagerWithProvenance'),
        ]
    ...
    def test_pipeline_with_provenance_supports_provenance_flag(self):
        ...
        """
        try:
            from reasongraph.pipeline.pipeline_builder import Pipeline
            from reasongraph.pipeline.pipeline_provenance import PipelineWithProvenance
...
class TestAllModulesEdgeCases:
    ...
    def test_all_modules_handle_none_config(self):
        ...
        modules = [
            ('reasongraph.context.context_provenance', 'ContextManagerWithProvenance'),
            ('reasongraph.embeddings.embeddings_provenance', 'EmbeddingGeneratorWithProvenance'),
        ]
    ...
    def test_all_modules_graceful_import_failure(self):
        ...
        modules = [
            'reasongraph.context.context_provenance',
            'reasongraph.pipeline.pipeline_provenance',
            'reasongraph.embeddings.embeddings_provenance',
        ]
    ...
    def test_storage_modules_handle_empty_operations(self):
        ...
        storage_modules = [
            ('reasongraph.graph_store.graph_store_provenance', 'GraphStoreWithProvenance'),
            ('reasongraph.vector_store.vector_store_provenance', 'VectorStoreWithProvenance'),
            ('reasongraph.triplet_store.triplet_store_provenance', 'TripletStoreWithProvenance'),
        ]
