...
from reasongraph.provenance.manager import ProvenanceManager
from reasongraph.provenance.schemas import ProvenanceEntry
...
def test_custom_storage_trace_lineage_one_argument_backward_compatibility():
    ...
    from reasongraph.provenance.storage import ProvenanceStorage
    from reasongraph.provenance.schemas import ProvenanceEntry
