...
class TestRelationExtractorProvenance:
    ...
    def test_without_provenance(self):
        ...
        try:
            from reasongraph.semantic_extract.semantic_extract_provenance import RelationExtractorWithProvenance
...
class TestEventDetectorProvenance:
    ...
    def test_without_provenance(self):
        ...
        try:
            from reasongraph.semantic_extract.semantic_extract_provenance import EventDetectorWithProvenance
