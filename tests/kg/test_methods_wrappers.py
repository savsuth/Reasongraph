...
from reasongraph.kg import methods

class TestMethodsWrappers(unittest.TestCase):
    
    @patch("reasongraph.kg.methods.GraphBuilder")
    ...
    @patch("reasongraph.kg.methods.GraphAnalyzer")
    ...
    @patch("reasongraph.kg.methods.EntityResolver")
