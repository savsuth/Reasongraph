...
class TestComputeNodeEmbeddings:
    ...
    @patch('reasongraph.kg.methods.NodeEmbedder')
...
class TestCalculateSimilarity:
    ...
    @patch('reasongraph.kg.methods.SimilarityCalculator')
    ...
    def test_calculate_similarity_missing_embeddings(self, mock_calculator_class):
        ...
        with patch('reasongraph.kg.methods._get_node_embedding', side_effect=mock_get_embedding):
...
class TestPredictLinks:
    ...
    @patch('reasongraph.kg.methods.LinkPredictor')
...
class TestFindShortestPath:
    ...
    @patch('reasongraph.kg.methods.PathFinder')
...
class TestCalculatePageRank:
    ...
    @patch('reasongraph.kg.methods.CentralityCalculator')
...
class TestDetectCommunitiesLabelPropagation:
    ...
    @patch('reasongraph.kg.methods.CommunityDetector')
