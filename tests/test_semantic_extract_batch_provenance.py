...
try:
    from reasongraph.semantic_extract.semantic_network_extractor import SemanticNetworkExtractor, SemanticNetwork, SemanticNode, SemanticEdge
    ...
    from reasongraph.semantic_extract.coreference_resolver import CoreferenceResolver, CoreferenceChain, Mention
...
class TestSemanticExtractBatch(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tracker_patcher = patch('reasongraph.utils.progress_tracker.get_progress_tracker')
