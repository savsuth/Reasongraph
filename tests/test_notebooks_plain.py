...
def test_12_embedding_generation():
    ...
    try:
        from reasongraph.embeddings import EmbeddingGenerator, TextEmbedder
...
def test_advanced_vector_store():
    ...
    try:
        from reasongraph.vector_store import FAISSStore, HybridSearch, MetadataFilter, SearchRanker, NamespaceManager
