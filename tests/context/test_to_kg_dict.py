...
from reasongraph.context.context_graph import ContextEdge, ContextGraph, ContextNode
...
def test_output_is_consumable_by_kg_utilities():
    ...
    from reasongraph.kg.graph_validator import GraphValidator, ValidationSeverity
