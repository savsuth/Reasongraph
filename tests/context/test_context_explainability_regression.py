...
from reasongraph.context.decision_models import Decision
from reasongraph.context.entity_linker import EntityLinker
from reasongraph.context.policy_engine import PolicyEngine
...
class TestKGConsumerCompatibility:
    ...
    def test_node_embedder_build_adjacency_normalizes_enriched_dicts(self):
        ...
        from reasongraph.kg.node_embeddings import NodeEmbedder
    ...
    def test_link_predictor_get_node_neighbors_normalizes_enriched_dicts(self):
        ...
        from reasongraph.kg.link_predictor import LinkPredictor
