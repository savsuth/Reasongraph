...
# Ensure the reasongraph package is in the path
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../')))

from reasongraph.context.entity_linker import EntityLinker, LinkedEntity, EntityLink
from reasongraph.context.context_graph import ContextGraph, ContextNode, ContextEdge
from reasongraph.context.agent_memory import AgentMemory, MemoryItem
from reasongraph.context.context_retriever import ContextRetriever, RetrievedContext
from reasongraph.context.agent_context import AgentContext
...
class TestContextModule(unittest.TestCase):
    ...
    @patch('reasongraph.context.agent_memory.AgentMemory._generate_embedding')
    ...
    def test_context_graph_preexisting_unrelated_cycle_does_not_block_new_write(self):
        ...
        from reasongraph.context.context_graph import ContextEdge
