...
class TestSnowflakeConnector:
    ...
    @patch("reasongraph.ingest.snowflake_ingestor.SNOWFLAKE_AVAILABLE", True)
    @patch("reasongraph.ingest.snowflake_ingestor.snowflake")
    def test_connector_init_with_password(self, mock_snowflake):
        """Test connector initialization with password authentication."""
        from reasongraph.ingest.snowflake_ingestor import SnowflakeConnector
...
class TestSnowflakeIngestor:
    ...
    def test_ingestor_init(self, mock_snowflake):
        ...
        from reasongraph.ingest.snowflake_ingestor import SnowflakeIngestor
    ...
    def test_export_as_documents(self, mock_snowflake):
        ...
        from reasongraph.ingest.snowflake_ingestor import SnowflakeData, SnowflakeIngestor
    ...
    def test_import_error_without_snowflake(self):
        ...
        with patch("reasongraph.ingest.snowflake_ingestor.SNOWFLAKE_AVAILABLE", False):
            from reasongraph.ingest.snowflake_ingestor import SnowflakeConnector
...
class TestSnowflakeData:
    ...
    def test_snowflake_data_creation(self):
        ...
        from reasongraph.ingest.snowflake_ingestor import SnowflakeData
