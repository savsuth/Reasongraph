...
from reasongraph.conflicts.conflict_analyzer import ConflictAnalyzer
from reasongraph.conflicts.conflict_detector import (
    Conflict,
    ConflictDetector,
    ConflictType,
)
from reasongraph.conflicts.conflict_resolver import ConflictResolver
from reasongraph.conflicts.investigation_guide import InvestigationGuideGenerator
from reasongraph.conflicts.source_tracker import SourceReference, SourceTracker
...
class TestConflictsModule(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_tracker_patcher = patch(
            "reasongraph.utils.progress_tracker.get_progress_tracker"
        )
