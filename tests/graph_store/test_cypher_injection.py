...
from reasongraph.graph_store.query_sanitize import sanitize_identifier
...
class TestAmazonNeptuneCypherInjection(unittest.TestCase):
    def _make_store(self):
        from reasongraph.graph_store.amazon_neptune import AmazonNeptuneStore
...
class TestNeo4jCypherInjection(unittest.TestCase):
    def _make_store(self):
        from reasongraph.graph_store import neo4j_store as m
...
class TestFalkorDBCypherInjection(unittest.TestCase):
    def _make_store(self):
        from reasongraph.graph_store import falkordb_store as m
...
class TestGraphStoreHopsForwarding(unittest.TestCase):
    ...
    def _make_graph_store_with_neo4j(self):
        ...
        """
        from reasongraph.graph_store import neo4j_store as m
        from reasongraph.graph_store.graph_store import (
            GraphAnalytics,
            GraphManager,
            GraphStore,
        )
