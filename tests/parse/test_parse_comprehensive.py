...
from reasongraph.parse.document_parser import DocumentParser, PDFParser, DOCXParser, HTMLParser
from reasongraph.parse.pptx_parser import PPTXParser
from reasongraph.parse.excel_parser import ExcelParser
from reasongraph.parse.structured_data_parser import StructuredDataParser, JSONParser, CSVParser, XMLParser
from reasongraph.parse.email_parser import EmailParser
from reasongraph.parse.code_parser import CodeParser
from reasongraph.parse.media_parser import MediaParser, ImageParser
from reasongraph.parse.web_parser import WebParser
from reasongraph.parse.registry import MethodRegistry
...
class TestParseComprehensive(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patchers = []
        modules_to_patch = [
            'reasongraph.parse.document_parser',
            'reasongraph.parse.structured_data_parser',
            'reasongraph.parse.email_parser',
            'reasongraph.parse.code_parser',
            'reasongraph.parse.media_parser',
            'reasongraph.parse.web_parser',
            'reasongraph.parse.pdf_parser',
            'reasongraph.parse.docx_parser',
            'reasongraph.parse.pptx_parser',
            'reasongraph.parse.excel_parser',
            'reasongraph.parse.html_parser',
            'reasongraph.parse.json_parser',
            'reasongraph.parse.csv_parser',
            'reasongraph.parse.xml_parser',
            'reasongraph.parse.image_parser'
        ]
    ...
    @patch('reasongraph.parse.pdf_parser.pdfplumber')
    ...
    @patch('reasongraph.parse.docx_parser.Document')
