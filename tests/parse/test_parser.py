...
import tempfile
import os
from reasongraph.parse.structured_data_parser import StructuredDataParser
from reasongraph.parse.json_parser import JSONParser, JSONData
...
class TestParser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger_patcher = patch('reasongraph.parse.structured_data_parser.get_logger', return_value=self.mock_logger)
        self.tracker_patcher = patch('reasongraph.parse.structured_data_parser.get_progress_tracker', return_value=self.mock_tracker)
        self.logger_patcher_jp = patch('reasongraph.parse.json_parser.get_logger', return_value=self.mock_logger)
        self.tracker_patcher_jp = patch('reasongraph.parse.json_parser.get_progress_tracker', return_value=self.mock_tracker)
    ...
    @patch('reasongraph.parse.structured_data_parser.JSONParser')
