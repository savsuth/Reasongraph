...
try:
    ...
    # Also mock reasongraph.semantic_extract.config to avoid initialization issues
    ...
    sys.modules["reasongraph.semantic_extract.config"] = mock_config_module
...
try:
    ...
    from reasongraph.semantic_extract.methods import extract_entities_huggingface, extract_relations_huggingface, extract_triplets_huggingface
