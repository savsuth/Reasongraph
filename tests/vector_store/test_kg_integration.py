...
from reasongraph.vector_store.decision_embedding_pipeline import DecisionEmbeddingPipeline
...
class TestKGAlgorithmIntegration:
    ...
    @patch('reasongraph.vector_store.decision_embedding_pipeline.NodeEmbedder')
    ...
    @patch('reasongraph.context.context_retriever.PathFinder')
    @patch('reasongraph.context.context_retriever.CommunityDetector')
    @patch('reasongraph.context.context_retriever.CentralityCalculator')
    ...
    def test_kg_algorithm_integration_in_decision_context(self):
        ...
        from reasongraph.context import DecisionContext
        
        # Mock decision pipeline to use KG algorithms
        with patch('reasongraph.context.decision_context.DecisionEmbeddingPipeline') as mock_pipeline:
