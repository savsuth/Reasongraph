...
# Ensure reasongraph is in path if running directly
if __name__ == "__main__":
    sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../')))

try:
    from reasongraph.vector_store.pinecone_store import (
        PineconeStore,
        PineconeClient,
        PineconeIndex,
        PineconeSearch,
...
class TestPineconeStore(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger_patcher = patch('reasongraph.vector_store.pinecone_store.get_logger', return_value=self.mock_logger)
        self.tracker_patcher = patch('reasongraph.vector_store.pinecone_store.get_progress_tracker', return_value=self.mock_tracker)
    ...
    @patch('reasongraph.vector_store.pinecone_store.PineconeClientLib')
    ...
    @patch('reasongraph.vector_store.pinecone_store.PINECONE_AVAILABLE', False)
