...
from reasongraph.vector_store.vector_store import VectorStore, VectorIndexer, VectorRetriever, VectorManager
from reasongraph.vector_store.registry import MethodRegistry, method_registry
from reasongraph.vector_store.faiss_store import FAISSStore, FAISSIndex, FAISSIndexBuilder, FAISSSearch
from reasongraph.vector_store.milvus_store import MilvusStore, MilvusClient, MilvusCollection, MilvusSearch
from reasongraph.vector_store.qdrant_store import QdrantStore
from reasongraph.vector_store.weaviate_store import WeaviateStore
from reasongraph.vector_store.hybrid_search import HybridSearch, MetadataFilter, SearchRanker
...
class TestVectorStoreDeepDive(unittest.TestCase):
    ...
    @patch('reasongraph.vector_store.faiss_store.faiss')
    @patch('reasongraph.vector_store.faiss_store.FAISS_AVAILABLE', True)
    ...
    @patch('reasongraph.vector_store.milvus_store.connections')
    @patch('reasongraph.vector_store.milvus_store.Collection')
    @patch('reasongraph.vector_store.milvus_store.utility')
    @patch('reasongraph.vector_store.milvus_store.DataType')
    @patch('reasongraph.vector_store.milvus_store.FieldSchema')
    @patch('reasongraph.vector_store.milvus_store.CollectionSchema')
    @patch('reasongraph.vector_store.milvus_store.MILVUS_AVAILABLE', True)
    ...
    @patch('reasongraph.vector_store.qdrant_store.QdrantClientLib')
    @patch('reasongraph.vector_store.qdrant_store.VectorParams')
    @patch('reasongraph.vector_store.qdrant_store.Distance')
    @patch('reasongraph.vector_store.qdrant_store.PointStruct')
    @patch('reasongraph.vector_store.qdrant_store.QDRANT_AVAILABLE', True)
    ...
    @patch('reasongraph.vector_store.weaviate_store.weaviate')
    @patch('reasongraph.vector_store.weaviate_store.MetadataQuery')
    @patch('reasongraph.vector_store.weaviate_store.WEAVIATE_AVAILABLE', True)
