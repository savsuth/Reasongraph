...
from reasongraph.vector_store.vector_store import VectorStore, VectorManager
...
try:
    from reasongraph.vector_store.sqlite_vec_store import SQLITE_VEC_AVAILABLE
except ImportError:
...
class SQLiteVecStoreCountTests(unittest.TestCase):
    ...
    def _make_store(self, dimension: int = 2):
        ...
        from reasongraph.vector_store.sqlite_vec_store import SQLiteVecStore
...
class PgVectorStoreCountTests(unittest.TestCase):
    ...
    def _make_mock_store(self, row_count: int):
        ...
        from reasongraph.vector_store import pgvector_store as pgmod
