...
import numpy as np
from reasongraph.vector_store.vector_store import VectorStore
...
class TestVectorStore(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.logger_patcher = patch('reasongraph.vector_store.vector_store.get_logger', return_value=self.mock_logger)
        self.tracker_patcher = patch('reasongraph.vector_store.vector_store.get_progress_tracker', return_value=self.mock_tracker)
        self.indexer_patcher = patch('reasongraph.vector_store.vector_store.VectorIndexer')
        self.retriever_patcher = patch('reasongraph.vector_store.vector_store.VectorRetriever')
