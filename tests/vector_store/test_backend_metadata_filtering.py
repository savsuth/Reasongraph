...
from reasongraph.vector_store.faiss_store import FAISSStore
from reasongraph.vector_store.qdrant_store import QdrantStore
from reasongraph.vector_store.pinecone_store import PineconeStore
from reasongraph.vector_store.milvus_store import MilvusStore
from reasongraph.vector_store.pgvector_store import PgVectorStore
from reasongraph.vector_store.weaviate_store import WeaviateStore
from reasongraph.utils.exceptions import ProcessingError, ValidationError
...
class TestBackendMetadataFiltering(unittest.TestCase):
    ...
    @patch('reasongraph.vector_store.qdrant_store.FieldCondition', MagicMock())
    @patch('reasongraph.vector_store.qdrant_store.MatchValue', MagicMock())
    @patch('reasongraph.vector_store.qdrant_store.Filter', MagicMock())
    ...
    @patch('reasongraph.vector_store.qdrant_store.Range', MagicMock())
    @patch('reasongraph.vector_store.qdrant_store.FieldCondition', MagicMock())
    @patch('reasongraph.vector_store.qdrant_store.Filter', MagicMock())
    @patch('reasongraph.vector_store.qdrant_store.QDRANT_AVAILABLE', True)
    def test_qdrant_store_filter_by_metadata_range(self):
        ...
        import reasongraph.vector_store.qdrant_store as qs_mod
    ...
    @patch('reasongraph.vector_store.qdrant_store.MatchAny', MagicMock())
    @patch('reasongraph.vector_store.qdrant_store.FieldCondition', MagicMock())
    @patch('reasongraph.vector_store.qdrant_store.Filter', MagicMock())
    @patch('reasongraph.vector_store.qdrant_store.QDRANT_AVAILABLE', True)
    ...
    @patch('reasongraph.vector_store.pinecone_store.PINECONE_AVAILABLE', True)
    ...
    @patch('reasongraph.vector_store.pgvector_store.PSYCOPG3_AVAILABLE', True)
    @patch('reasongraph.vector_store.pgvector_store.psycopg_sql')
    ...
    def test_pinecone_store_get_index_sets_dimension_from_stats(self):
        ...
        with patch(
            'reasongraph.vector_store.pinecone_store.PineconeIndex'
        ) as mock_index_cls:
    ...
    def test_weaviate_store_filter_by_metadata(self):
        ...
        with patch('reasongraph.vector_store.weaviate_store.WEAVIATE_AVAILABLE', True):
    ...
    def test_weaviate_store_filter_by_metadata_native_filter(self):
        ...
        with patch('reasongraph.vector_store.weaviate_store.WEAVIATE_AVAILABLE', True), \
             patch('reasongraph.vector_store.weaviate_store.weaviate', mock_module):
