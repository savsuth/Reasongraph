"""
Extended Real-World Test Suite for Reasongraph 0.3.0-alpha and 0.3.0-beta
...
from reasongraph.export.parquet_exporter import PARQUET_AVAILABLE
...
from reasongraph.kg.kg_provenance import (
...
class TestParquetExportRealData:
    ...
    def test_parquet_convenience_function(self, kg_data, tmp_path):
        from reasongraph.export.methods import export_parquet
...
class TestArangoAQLExportRealData:
    ...
    def test_arango_exporter_importable(self):
        from reasongraph.export.arango_aql_exporter import ArangoAQLExporter
    ...
    def test_arango_convenience_function(self, ai_kg_data, tmp_path):
        from reasongraph.export.methods import export_arango
...
class TestSemanticRelationshipDeduplicationV2:
    ...
    def _make_dedup_triplets(self):
        from reasongraph.deduplication.methods import dedup_triplets
...
class TestAgentMemoryRealWorld:
    ...
    def test_store_with_entities_and_relationships(self):
        ...
        from reasongraph.context import AgentMemory, MemoryItem
