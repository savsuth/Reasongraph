...
from reasongraph.deduplication.cluster_builder import Cluster, ClusterBuilder
from reasongraph.deduplication.duplicate_detector import (
    DuplicateDetector,
    DuplicateGroup,
)
from reasongraph.deduplication.entity_merger import EntityMerger
from reasongraph.deduplication.merge_strategy import (
    MergeStrategy,
...
class TestIncrementalDetectionCoverage(unittest.TestCase):
    ...
    def test_methods_incremental_detect_duplicates(self):
        from reasongraph.deduplication.duplicate_detector import DuplicateCandidate
