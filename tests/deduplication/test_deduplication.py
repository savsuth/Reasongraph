...
from reasongraph.deduplication.similarity_calculator import SimilarityCalculator
from reasongraph.deduplication.duplicate_detector import (
    DuplicateCandidate,
    DuplicateDetector,
)
from reasongraph.deduplication.entity_merger import EntityMerger
from reasongraph.deduplication.merge_strategy import MergeStrategy
from reasongraph.deduplication.cluster_builder import ClusterBuilder
from reasongraph.deduplication.registry import MethodRegistry
...
from reasongraph.utils.progress_tracker import ConsoleProgressDisplay
...
class TestDeduplication(unittest.TestCase):
    ...
    def test_entity_merger_string_strategies(self):
        ...
        from reasongraph.deduplication.merge_strategy import MergeStrategyManager
...
class TestProgressTrackerEncoding(unittest.TestCase):
    ...
    def test_safe_write_does_not_crash_on_cp1252(self):
        ...
        try:
            display._safe_write("🧠 Reasongraph - 📊 Current Progress\n")
    ...
    def test_update_pipeline_header_does_not_crash_on_cp1252(self):
        ...
        from reasongraph.utils.progress_tracker import ProgressItem
        display = ConsoleProgressDisplay()
