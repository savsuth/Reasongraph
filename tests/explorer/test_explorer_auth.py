...
REASONGRAPH_ALLOW_ANONYMOUS=true is set explicitly, and that health/info/
...
# ---------------------------------------------------------------------------
# Fail-closed: no REASONGRAPH_API_KEY and no explicit anonymous opt-in.
# ---------------------------------------------------------------------------

def test_protected_route_returns_503_when_auth_not_configured(client, monkeypatch):
    monkeypatch.delenv("REASONGRAPH_ALLOW_ANONYMOUS", raising=False)
...
def test_protected_route_rejects_missing_key(client, monkeypatch):
    monkeypatch.delenv("REASONGRAPH_ALLOW_ANONYMOUS", raising=False)
    monkeypatch.setenv("REASONGRAPH_API_KEY", "correct-key")
...
# ---------------------------------------------------------------------------
# Explicit opt-in: REASONGRAPH_ALLOW_ANONYMOUS=true.
# ---------------------------------------------------------------------------
...
# cover WebSocket handshakes at all, so under REASONGRAPH_ALLOW_ANONYMOUS the
