...
class TestHealthInfo:
    def test_root_without_frontend_bundle_shows_diagnostic(self, tmp_path, monkeypatch, client):
        from reasongraph.explorer import app as app_module

        package_dir = tmp_path / "reasongraph"
    ...
    def test_info(self, client):
        ...
        assert payload["name"] == "Reasongraph Knowledge Explorer"
...
from reasongraph.utils.helpers import classify_path_distance
...
class TestDecisionResponseTimestampValidator:
    ...
    def _make(self, ts):
        from reasongraph.explorer.schemas import DecisionResponse
...
class TestEnrichExtractValidation:
    ...
    def test_import_failure_returns_503_not_422(self, client, monkeypatch):
        ...
        import reasongraph.explorer.routes.enrich as enrich_module
