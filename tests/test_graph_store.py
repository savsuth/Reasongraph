...
class TestGraphStore(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher = patch('reasongraph.graph_store.neo4j_store.Neo4jStore', side_effect=MockGraphStore)
...
class TestGraphStoreInitialization(unittest.TestCase):
    def test_falkordb_initialization(self):
        with patch('reasongraph.graph_store.falkordb_store.FalkorDBStore', side_effect=MockGraphStore) as mock_falkor:
