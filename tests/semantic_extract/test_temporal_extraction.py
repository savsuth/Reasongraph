...
# ── Mock optional heavyweight dependencies before any reasongraph import ──────
...
from reasongraph.semantic_extract.schemas import (
    RelationsResponse,
    RelationsWithTemporalResponse,
)
from reasongraph.kg.temporal_normalizer import TemporalNormalizer
from reasongraph.utils.exceptions import TemporalAmbiguityWarning
...
class TestTemporalExtractionFlag(unittest.TestCase):
    ...
    def setUp(self):
        from reasongraph.semantic_extract.methods import _result_cache
        _result_cache.clear()
    ...
    def test_low_temporal_confidence_logs_warning(self, mock_create):
        ...
        with self.assertLogs("reasongraph", level="WARNING") as cm:
...
class TestFullPipelineTemporalToBiTemporal(unittest.TestCase):
    ...
    def test_full_pipeline_explicit_date(self, mock_create):
        ...
        from reasongraph.kg.temporal_model import BiTemporalFact
