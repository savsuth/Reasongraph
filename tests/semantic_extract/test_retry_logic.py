...
from reasongraph.semantic_extract.methods import extract_entities_llm, _extract_entities_chunked, extract_relations_llm, extract_triplets_llm
from reasongraph.semantic_extract.providers import BaseProvider
...
class TestRetryLogic(unittest.TestCase):
    ...
    def test_chunked_extraction_propagation(self, mock_create_provider):
        ...
        with patch('reasongraph.split.TextSplitter') as MockSplitter:
    ...
    def test_provider_base_logic(self):
        ...
        with patch('reasongraph.semantic_extract.providers.instructor') as mock_instructor:
