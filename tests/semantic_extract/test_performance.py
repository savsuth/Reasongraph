...
from reasongraph.semantic_extract.providers import create_provider, ProviderPool, _provider_pool
...
from reasongraph.semantic_extract.methods import _result_cache, extract_entities_llm, extract_relations_llm, extract_triplets_llm, match_entity
...
class TestSemanticExtractImprovements(unittest.TestCase):
    ...
    def test_caching(self):
        ...
        with patch('reasongraph.semantic_extract.methods.create_provider', return_value=mock_provider) as mock_create:
    ...
    def test_secure_caching(self):
        ...
        with patch('reasongraph.semantic_extract.methods.create_provider', return_value=mock_provider):
    ...
    def test_provider_pool(self):
        ...
        with patch('reasongraph.semantic_extract.providers.OpenAIProvider') as MockProvider:
