...
from reasongraph.semantic_extract.methods import extract_entities_llm
...
class TestProviderLimits:
    ...
    def test_anthropic_max_tokens_defaults(self):
        from reasongraph.semantic_extract.providers import AnthropicProvider
    ...
    def test_groq_max_completion_tokens(self):
        from reasongraph.semantic_extract.providers import GroqProvider
    ...
    def test_gemini_params(self):
        from reasongraph.semantic_extract.providers import GeminiProvider
...
class TestTemperatureParameter:
    ...
    def test_deepseek_temperature_none_omitted(self):
        ...
        from reasongraph.semantic_extract.providers import DeepSeekProvider
...
class TestChunkingDefaults:
    ...
    @patch("reasongraph.semantic_extract.methods._extract_entities_chunked")
