import unittest
from reasongraph.reasoning.sparql_reasoner import SPARQLReasoner, SPARQLQueryResult
from reasongraph.reasoning.abductive_reasoner import AbductiveReasoner, Observation, HypothesisRanking
from reasongraph.reasoning.deductive_reasoner import DeductiveReasoner, Premise, Argument
from reasongraph.reasoning.reasoner import Rule
...
class TestSpecializedReasoners(unittest.TestCase):
    ...
    def test_abductive_reasoner_rank_hypotheses(self):
        ...
        from reasongraph.reasoning.abductive_reasoner import Hypothesis
