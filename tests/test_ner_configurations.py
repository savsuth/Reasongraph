...
from reasongraph.semantic_extract.named_entity_recognizer import NamedEntityRecognizer
...
class TestNERConfigurations(unittest.TestCase):
    ...
    @patch('reasongraph.semantic_extract.methods.spacy')
    def test_ner_ml_config_spacy_available(self, mock_spacy):
        ...
        with patch('reasongraph.semantic_extract.methods.SPACY_AVAILABLE', True):
    ...
    def test_ner_ml_init_falls_back_when_spacy_runtime_is_broken(self, mock_spacy):
        ...
        """
        from reasongraph.semantic_extract.methods import clear_spacy_model_cache
        clear_spacy_model_cache()
        mock_spacy.load.side_effect = RuntimeError("ConfigSchemaNlp is not fully defined")

        with patch('reasongraph.semantic_extract.ner_extractor.SPACY_AVAILABLE', True):
    ...
    @patch('reasongraph.semantic_extract.methods.HuggingFaceModelLoader')
