...
from reasongraph.pipeline.execution_engine import ExecutionResult
...
class TestPipelineWithProvenance:
    ...
    def test_provenance_disabled_when_import_fails(self, simple_pipeline):
        """When reasongraph.provenance is unavailable, provenance should be disabled."""
        # Force the provenance import to raise ImportError
        with patch.dict(sys.modules, {"reasongraph.provenance": None}):
