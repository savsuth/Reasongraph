...
from reasongraph.pipeline.pipeline_builder import PipelineBuilder, StepStatus, Pipeline
from reasongraph.pipeline.execution_engine import ExecutionEngine, PipelineStatus
from reasongraph.pipeline.failure_handler import (
    FailureHandler, RetryPolicy, RetryStrategy, ErrorSeverity
)
from reasongraph.pipeline.parallelism_manager import ParallelismManager, Task
...
class TestPipelineComprehensive(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Mock logger
        self.mock_logger_patcher = patch("reasongraph.utils.logging.get_logger")
