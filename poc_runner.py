"""
Standalone PoC runner for 3 security vulnerabilities in reasongraph.
...
def poc_vuln1():
    ...
    print("="*70)
    print("Source: reasongraph/explorer/routes/provenance.py lines 332-344")
    print()
...
def poc_vuln2():
    ...
    print("="*70)
    print("Source: reasongraph/explorer/routes/enrich.py lines 197-198")
    print()
...
if __name__ == "__main__":
    print("reasongraph Security PoC Runner")
