...
Reasongraph provides both simple functional wrappers and comprehensive class APIs for different use cases:
...
```python
from reasongraph.deduplication import detect_duplicates
...
```python
from reasongraph.deduplication import build_clusters
...
```python
from reasongraph.deduplication import detect_duplicates, merge_entities
...
```python
from reasongraph.deduplication import DuplicateDetector, EntityMerger, calculate_similarity
...
```python
from reasongraph.deduplication import build_clusters, EntityMerger
