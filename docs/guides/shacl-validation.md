...
In Reasongraph, `SHACLGenerator` produces constraint rules (shapes) based on your ontology, and `_run_pyshacl` evaluates your actual data against these rules. If a node violates a rule (e.g., missing a required property or using the wrong datatype), a detailed violation report is generated.
...
from reasongraph.ontology import OntologyGenerator, SHACLGenerator, PropertyShape
from reasongraph.ontology.ontology_validator import _run_pyshacl
...
```python
from reasongraph.ontology import SHACLGenerator
...
```python
from reasongraph.ontology import PropertyShape
...
```python
from reasongraph.ontology import NodeShape, PropertyShape, SHACLGraph
...
```python
from reasongraph.ontology import LLMOntologyGenerator, SHACLGenerator, PropertyShape
from reasongraph.ontology.ontology_validator import _run_pyshacl
