...
description: "How Reasongraph records, stores, traces, and queries AI agent decisions as first-class knowledge graph objects — with causal chains, precedent search, policy enforcement, and full explainability."
icon: "scale-balanced"
---
...
```python
from reasongraph.context import Decision
...
```python
from reasongraph.context import PolicyEngine, Policy, Decision
from datetime import datetime
...
```python
from reasongraph.context import DecisionRecorder
...
```python
from reasongraph.context import AgentContext, ContextGraph, PolicyEngine, Policy
from reasongraph.vector_store import VectorStore
from datetime import datetime
...
```python
from reasongraph.context import AgentContext, ContextGraph, DecisionRecorder
from reasongraph.vector_store import VectorStore
...
```python
from reasongraph.context import AgentContext, ContextGraph, PolicyEngine, Policy
from reasongraph.context import Decision, DecisionRecorder
from reasongraph.vector_store import VectorStore
from datetime import datetime
