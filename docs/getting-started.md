...
<Steps>
  <Step title="Install Reasongraph">
    ...
    <Check>
      ...
      ```python
      import reasongraph
      print(reasongraph.__version__)  # 0.6.5
      ```
    </Check>
  </Step>
  ...
  <Step title="Choose your path">
    ...
    | **MCP Integration** | Use Reasongraph from Claude Desktop or VS Code | [MCP Server](reference/mcp_server) |
...
<Tabs>
  ...
  <Tab title="MCP Integration">
    Use Reasongraph from Claude Desktop, VS Code, Cursor, or any MCP client: no Python code required after setup.
...
Reasongraph uses a modular, layered architecture: import only what you need.
...
- [GitHub Issues](https://github.com/savsuth/Reasongraph/issues) — Report bugs or request features.
