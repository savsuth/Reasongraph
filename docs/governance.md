...
> Reasongraph is maintained by Aasav Suthar with community contributions under an open governance model.


## Roles

- **Maintainers** — Aasav Suthar: review and merge PRs, manage releases and code quality, set project direction and community standards.
- **Contributors** — Submit code, documentation, and bug reports. Help with issues and reviews.
- **Community Members** — Use Reasongraph, provide feedback, share use cases, and participate in GitHub Discussions and Discord.
...
Reasongraph follows **Semantic Versioning** (`MAJOR.MINOR.PATCH`):
...
- **Security Advisories**: [report security issues privately](https://github.com/savsuth/Reasongraph/security/advisories/new)
...
MIT License: see [LICENSE](https://github.com/savsuth/Reasongraph/blob/main/LICENSE) and the [License page](project-license).
