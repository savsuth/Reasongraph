...
description: "Ingest structured data from Snowflake tables and queries into Reasongraph's KG pipeline."
icon: "snowflake"
---

> Extract data from Snowflake into Reasongraph with password, key-pair, OAuth, and SSO authentication.
...
```python
from reasongraph.ingest import SnowflakeConnector
