...
description: "Ingest Unity Catalog metadata and Delta Lake tables from Databricks into Reasongraph's KG pipeline."
icon: "cloud"
---

> Extract Delta Lake tables and Unity Catalog metadata (schemas, lineage) from Databricks into Reasongraph with personal access token or OAuth M2M authentication.
...
## Export as Reasongraph Documents
...
```python
from reasongraph.ingest import DatabricksConnector
