...
Docling is integrated into Reasongraph's `parse` module via the **`DoclingParser`**. Documents pass through Docling's **layout engine**, then feed directly into Reasongraph's extraction and KG pipeline.
