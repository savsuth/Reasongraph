...
`reasongraph.context` is the memory and decision layer for AI agents:
...
<Tabs>
  ...
  <Tab title="Policy Enforcement">
    ...
    ```python
    from reasongraph.context import AgentContext, ContextGraph, PolicyEngine
    from reasongraph.vector_store import VectorStore
...
```python
from reasongraph.context import AgentMemory
from reasongraph.vector_store import VectorStore
...
```python
from reasongraph.context import PolicyEngine
from reasongraph.context import ContextGraph
from reasongraph.context.decision_models import Policy, Decision
...
```python
from reasongraph.context import EntityLinker
...
print(uri)  # "https://reasongraph.dev/entity/apple_inc.#organization"
...
| `uri` | `str` | Generated URI (e.g. `"https://reasongraph.dev/entity/apple_inc."`) |
...
```python
from reasongraph.context import ContextRetriever
...
- [Context Module](https://github.com/savsuth/Reasongraph/blob/main/cookbook/introduction/19_Context_Module.ipynb) — Memory and decision tracking · Intermediate
- [Advanced Context Engineering](https://github.com/savsuth/Reasongraph/blob/main/cookbook/advanced/11_Advanced_Context_Engineering.ipynb) — Production FAISS + Neo4j setup · Advanced
