...
```python
from reasongraph.explorer import GraphSession
...
- [Distance Intelligence](https://github.com/savsuth/Reasongraph/blob/main/cookbook/advanced/12_Distance_Intelligence.ipynb) — Semantic neighborhoods and distance matrices · Advanced
