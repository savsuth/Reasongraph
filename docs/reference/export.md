...
**`reasongraph.export`** serializes knowledge graphs to **every downstream format**:
...
```python
from reasongraph.export import export_rdf, export_csv, export_lpg
...
<Tabs>
  <Tab title="RDF">
    ...
    **Namespace management:**
    ...
    ```python
    from reasongraph.export import NamespaceManager, RDFExporter

    ns_manager = NamespaceManager()
    # ns_manager.namespaces contains the built-in prefix dict (rdf, rdfs, owl, xsd, reasongraph)
  ...
  <Tab title="Vectors, Arrow & Reports">
    ...
    **ArrowExporter**: requires `pyarrow`:
    ...
    ```python
    from reasongraph.export import ArrowExporter
    ...
    **DistanceExporter**: takes a `graph` argument at construction:
    ...
    ```python
    from reasongraph.export import DistanceExporter
