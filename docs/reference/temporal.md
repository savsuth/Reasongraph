...
<Tabs>
  ...
  <Tab title="TemporalBound.OPEN">
    ...
    ```python
    from reasongraph.kg import TemporalBound
...
```python
from reasongraph.kg import TemporalPatternDetector
...
```python
from reasongraph.kg import TemporalNormalizer
from datetime import datetime, timezone
...
```python
from reasongraph.kg import TemporalQueryRewriter
...
<Tabs>
  ...
  <Tab title="Policy Evolution">
    ```python
    from reasongraph.kg import TemporalVersionManager, TemporalGraphQuery
  ...
  <Tab title="NL Query Rewriting">
    ```python
    from reasongraph.kg import TemporalQueryRewriter, TemporalGraphQuery
...
- [Temporal Knowledge Graphs](https://github.com/savsuth/Reasongraph/blob/main/cookbook/advanced/10_Temporal_Knowledge_Graphs.ipynb) — Temporal reasoning and Allen algebra · Advanced
- [Context Module](https://github.com/savsuth/Reasongraph/blob/main/cookbook/introduction/19_Context_Module.ipynb) — Including temporal decision windows · Intermediate
