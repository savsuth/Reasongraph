...
**`reasongraph.embeddings`** converts text and graph structures into **dense vector representations**:
...
<Tabs>
  <Tab title="FastEmbed (default)">
    ...
    ```bash
    pip install "reasongraph[fastembed]"
    ```
  ...
  <Tab title="Sentence-Transformers">
    ...
    ```bash
    pip install reasongraph  # sentence-transformers included
    ```
  ...
  <Tab title="BGE">
    ...
    ```python
    from reasongraph.embeddings import BGEStore, EmbeddingGenerator
  ...
  <Tab title="OpenAI">
    ...
    ```bash
    pip install "reasongraph[llm-openai]"
...
<Tabs>
  ...
  <Tab title="Strategy Comparison">
    ...
    ```python
    from reasongraph.embeddings import PoolingStrategyFactory
...
<Tabs>
  ...
  <Tab title="Provider Comparison">
    ```python
    from reasongraph.embeddings import check_available_providers, EmbeddingGenerator
...
```python
from reasongraph.embeddings import calculate_similarity
