...
`reasongraph.kg` transforms extracted entities and relationships into structured, queryable knowledge graphs:
...
<Tip>
  For conflict detection and advanced entity resolution, use `reasongraph.conflicts` and `reasongraph.deduplication` alongside this module.
</Tip>
...
```python
from reasongraph.kg import BiTemporalFact, TemporalBound
...
```python
from reasongraph.kg import TemporalNormalizer, TemporalQueryRewriter
from datetime import datetime, timezone
...
```python
from reasongraph.kg import TemporalVersionManager
...
```python
from reasongraph.kg import SimilarityCalculator, NodeEmbedder
...
<Tabs>
  <Tab title="Centrality">
    ...
    ```python
    from reasongraph.kg import CentralityCalculator
  ...
  <Tab title="Community Detection">
    ...
    ```python
    from reasongraph.kg import CommunityDetector
  ...
  <Tab title="Path Finding">
    ...
    ```python
    from reasongraph.kg import PathFinder
  ...
  <Tab title="Link Prediction">
    ...
    ```python
    from reasongraph.kg import LinkPredictor
  ...
  <Tab title="Node Embeddings">
    ...
    ```python
    from reasongraph.kg import NodeEmbedder, SimilarityCalculator
...
```python
from reasongraph.kg import GraphValidator
...
- [Building Knowledge Graphs](https://github.com/savsuth/Reasongraph/blob/main/cookbook/introduction/07_Building_Knowledge_Graphs.ipynb): fundamentals of KG construction · Beginner
- [Your First Knowledge Graph](https://github.com/savsuth/Reasongraph/blob/main/cookbook/introduction/08_Your_First_Knowledge_Graph.ipynb): entity extraction to visualization · Beginner
- [Graph Analytics](https://github.com/savsuth/Reasongraph/blob/main/cookbook/introduction/10_Graph_Analytics.ipynb): centrality and community detection · Intermediate
- [Advanced Graph Analytics](https://github.com/savsuth/Reasongraph/blob/main/cookbook/advanced/02_Advanced_Graph_Analytics.ipynb): PageRank, Louvain, shortest path · Advanced
- [Temporal Knowledge Graphs](https://github.com/savsuth/Reasongraph/blob/main/cookbook/advanced/10_Temporal_Knowledge_Graphs.ipynb): temporal logic and graph evolution · Advanced
