...
**`reasongraph.normalize`** standardizes raw data **before extraction and graph construction**:
...
<Steps>
  ...
  <Step title="DateNormalizer and NumberNormalizer: parse structured values">
    ```python
    from reasongraph.normalize import DateNormalizer, NumberNormalizer
...
<Tabs>
  ...
  <Tab title="EntityNormalizer">
    ...
    **Sub-normalizers:**
    ...
    ```python
    from reasongraph.normalize import AliasResolver, EntityDisambiguator, NameVariantHandler
  ...
  <Tab title="DateNormalizer">
    ...
    **Sub-normalizers:**
    ...
    ```python
    from reasongraph.normalize import TimeZoneNormalizer, RelativeDateProcessor, TemporalExpressionParser
  ...
  <Tab title="NumberNormalizer">
    ...
    **Unit and currency conversion:**
    ...
    ```python
    from reasongraph.normalize import UnitConverter, CurrencyNormalizer
...
```python
from reasongraph.normalize import DataCleaner, DataValidator, DuplicateDetector
...
from reasongraph.normalize import normalize_text
