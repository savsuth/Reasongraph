...
<Info>
  **v0.5.0** — Ontology Hub, Distance Intelligence, Parquet & XML ingestion, 12 security fixes. <a href="https://github.com/savsuth/Reasongraph/releases" style={{color:"#10B981",fontWeight:600,textDecoration:"none"}}>What's new →</a>
</Info>
...
<img src="/assets/img/diagrams/pipeline-flow.svg" alt="Reasongraph end-to-end pipeline: Ingest → Parse → Normalize → Extract → Build KG → QA → Store → Deliver" style={{ width: '100%', borderRadius: '10px', margin: '0 0 24px' }} />
...
from reasongraph.ingest import ParquetIngestor, XMLIngestor
...
from reasongraph.export import ParquetExporter
...
```python ArangoDB
from reasongraph.export import ArangoAQLExporter
...
```python
from reasongraph.kg import GraphBuilder, TemporalGraphQuery
...
- [Core Concepts](concepts) — Knowledge graphs, ontologies, reasoning engines: the mental model behind Reasongraph.
