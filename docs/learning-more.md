...
Whether you're running your first pipeline or deploying Reasongraph in production, this page gives you a structured path forward: from beginner to enterprise-grade usage.


## Learning Paths

- **Beginner (1–2 hrs)** — New to Reasongraph and knowledge graphs. [Start with Installation →](installation)
...
<Tabs>
  <Tab title="Beginner (1–2 hrs)">
    New to Reasongraph and knowledge graphs. No prior graph database experience required.
    ...
    <Steps>
      ...
      <Step title="Explore interactively">
        [Welcome to Reasongraph notebook](https://github.com/savsuth/Reasongraph/blob/main/cookbook/introduction/01_Welcome_to_Reasongraph.ipynb): Jupyter walkthrough of every module.
      </Step>
    </Steps>
  </Tab>
  <Tab title="Intermediate (4–6 hrs)">
    ...
    <Steps>
      ...
      <Step title="Build production knowledge graphs">
        [Building Knowledge Graphs notebook](https://github.com/savsuth/Reasongraph/blob/main/cookbook/introduction/07_Building_Knowledge_Graphs.ipynb): multi-source, deduplication, conflict resolution.
      </Step>
      <Step title="Add semantic search">
        [Embeddings notebook](https://github.com/savsuth/Reasongraph/blob/main/cookbook/introduction/09_Embeddings.ipynb): providers, pooling strategies, vector stores.
      </Step>
      <Step title="Multi-source integration">
        [Multi-Source Data Integration notebook](https://github.com/savsuth/Reasongraph/blob/main/cookbook/advanced/06_Multi_Source_Data_Integration.ipynb) for multi-source patterns.
      </Step>
    </Steps>
  </Tab>
  <Tab title="Advanced (8+ hrs)">
    ...
    <Steps>
      ...
      <Step title="Temporal intelligence">
        [Temporal Graphs notebook](https://github.com/savsuth/Reasongraph/blob/main/cookbook/advanced/10_Temporal_Knowledge_Graphs.ipynb): `valid_from`/`valid_until`, Allen interval algebra, point-in-time queries.
      </Step>
      <Step title="Ontology-driven knowledge bases">
        [Ontology notebook](https://github.com/savsuth/Reasongraph/blob/main/cookbook/introduction/14_Ontology.ipynb): auto-generation, SHACL validation, Ontology Hub (v0.5.0).
      </Step>
      <Step title="Advanced visualization">
        [Complete Visualization Suite notebook](https://github.com/savsuth/Reasongraph/blob/main/cookbook/advanced/03_Complete_Visualization_Suite.ipynb): UMAP, t-SNE, community layouts, embedding projections.
      </Step>
      <Step title="Enterprise export">
        [Multi-Format Export notebook](https://github.com/savsuth/Reasongraph/blob/main/cookbook/advanced/05_Multi_Format_Export.ipynb): RDF with PROV-O, Parquet, Neo4j Cypher, Arrow, OWL.
      </Step>
    </Steps>
  </Tab>
</Tabs>
...
| Embedding Provider | `REASONGRAPH_EMBEDDING_PROVIDER` | `"openai"` |
| Graph Backend | `REASONGRAPH_GRAPH_BACKEND` | `"networkx"` |
| Log Level | `REASONGRAPH_LOG_LEVEL` | `"INFO"` |
| Log Format | `REASONGRAPH_LOG_FORMAT` | `"text"` |
...
```bash
pip install "reasongraph[llm-openai]"   # OpenAI provider
pip install "reasongraph[gpu]"          # GPU acceleration
```
...
```bash
pip install "reasongraph[gpu]"  # CUDA-backed embeddings
```
...
Or install extras individually: `pip install "reasongraph[core]"`, then add `[llm-openai]`, `[gpu]`, etc. as needed.
