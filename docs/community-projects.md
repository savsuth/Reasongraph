...
description: "Projects, extensions, and integrations built by the Reasongraph community."
icon: "people-group"
---

<Tip>
  Building something with Reasongraph? [Submit it on GitHub](https://github.com/savsuth/Reasongraph/issues/new?template=community_project.md): we'd love to feature it here.
</Tip>

Reasongraph is used across academia, enterprise, and independent research. Below is a snapshot of the ecosystem being built by the community.


## Projects Using Reasongraph

### Research & Academia

Teams in academia are using Reasongraph to build structured, auditable knowledge from unstructured scientific literature.
...
- **GraphRAG toolkits**: custom retrieval layers built on top of Reasongraph's `context` + `vector_store` modules
- **Domain-specific extractors**: NER and relation extractors for clinical, legal, and scientific text
- **Temporal graph dashboards**: visual timelines built with Reasongraph's `TemporalKnowledgeGraph` + custom visualization adapters
...
- **Evaluation harnesses**: domain-specific precision/recall benchmarks using `reasongraph.evals`


## Build Your Own Extension

Any Reasongraph component can be extended via the registry pattern:
...
- [GitHub Issues](https://github.com/savsuth/Reasongraph/issues) — Report bugs, request features, or propose integrations.
- [Discord](https://discord.gg/sV34vps5hH) — Share what you're building with the community.
- [GitHub Discussions](https://github.com/savsuth/Reasongraph/discussions) — Long-form questions, design discussions, and ideas.
