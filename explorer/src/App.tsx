        ...
        <section className="landing-hero">
          <div className="landing-copy">
            <div className="landing-status-bar" data-status={stats.status}>
              ...
              <span className="landing-status-version">Reasongraph v2 · Semantic Intelligence</span>
            </div>
            ...
            <p className="landing-subtitle">
              Reasongraph turns dense knowledge graphs into a navigable command center —
          ...
          <div className="landing-preview" aria-label="Knowledge graph preview">
            <div className="landing-preview-topbar" aria-hidden="true">
              ...
              <div className="landing-preview-dot" />
              <div className="landing-preview-dot" />
              <div className="landing-preview-tab">Reasongraph Explorer</div>
            </div>
          ...
          <div className="landing-workspace-grid">
            <button className="landing-workspace-card landing-workspace-card--primary" type="button" onClick={onOpenNetwork}>
              <div>
                ...
                <div className="landing-workspace-card-title">Reasongraph Explorer</div>
    ...
    <QueryClientProvider client={queryClient}>
      ...
      <div className="app-shell">
        <aside className="app-rail">
          <button className="brand-pill" title="Reasongraph Knowledge Explorer" onClick={() => setActiveWorkspace('welcome')} style={{ cursor: 'pointer', border: '1px solid rgba(127,208,255,0.18)' }}>SKE</button>
