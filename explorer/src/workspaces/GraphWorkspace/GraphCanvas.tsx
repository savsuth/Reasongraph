...
import {
  REASONGRAPH_EDGE_PROGRAM_CLASSES,
  REASONGRAPH_NODE_PROGRAM_CLASSES,
  drawReasongraphNodeHover,
  drawReasongraphNodeLabel,
...
const SIGMA_SETTINGS = {
  ...
  nodeProgramClasses: REASONGRAPH_NODE_PROGRAM_CLASSES,
  edgeProgramClasses: REASONGRAPH_EDGE_PROGRAM_CLASSES,
  defaultDrawNodeLabel: drawReasongraphNodeLabel,
  defaultDrawNodeHover: drawReasongraphNodeHover,
};
