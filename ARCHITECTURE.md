...
flowchart TD
    %% ── SOURCES ──────────────────────────────────────────────────────
    subgraph SRC["🗂️ Sources  (reasongraph.ingest)"]
        direction LR
...
*→ [README](README.md) · [Docs](https://docs.getreasongraph.ai/) · [Cookbook](https://github.com/savsuth/Reasongraph/tree/main/cookbook)*
